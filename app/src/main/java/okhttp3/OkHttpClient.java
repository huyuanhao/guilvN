...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder callTimeout(long j, TimeUnit timeUnit) {
            this.callTimeout = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, j, timeUnit);
            return this;
        }
        ...
        public Builder connectTimeout(long j, TimeUnit timeUnit) {
            this.connectTimeout = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, j, timeUnit);
            return this;
        }
        ...
        public Builder readTimeout(long j, TimeUnit timeUnit) {
            this.readTimeout = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, j, timeUnit);
            return this;
        }
        ...
        public Builder writeTimeout(long j, TimeUnit timeUnit) {
            this.writeTimeout = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, j, timeUnit);
            return this;
        }

        @IgnoreJRERequirement
        public Builder callTimeout(Duration duration) {
            this.callTimeout = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        @IgnoreJRERequirement
        public Builder connectTimeout(Duration duration) {
            this.connectTimeout = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        @IgnoreJRERequirement
        public Builder pingInterval(Duration duration) {
            this.pingInterval = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        @IgnoreJRERequirement
        public Builder readTimeout(Duration duration) {
            this.readTimeout = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        @IgnoreJRERequirement
        public Builder writeTimeout(Duration duration) {
            this.writeTimeout = Util.checkDuration(C7486o0OoO0oO.f20312OooO0Oo, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
    ...
    static {
        Internal.instance = new Internal() {
            /* class okhttp3.OkHttpClient.C47561 */
