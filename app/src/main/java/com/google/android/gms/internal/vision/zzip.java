...
public final class zzip {
    public static final zzip zzaas = new zzip(0, new int[0], new Object[0], false);
    public int count;
    public int[] zzaat;
    public boolean zzrl;
    public int zzwk;
    ...
    public static zzip zza(zzip zzip, zzip zzip2) {
    ...
    public zzip(int i, int[] iArr, Object[] objArr, boolean z) {
        this.zzwk = -1;
        this.count = i;
        this.zzaat = iArr;
        this.zzze = objArr;
    ...
    public static void zzb(int i, Object obj, zzjj zzjj) throws IOException {
        int i2 = i >>> 3;
        int i3 = i & 7;
        if (i3 == 0) {
