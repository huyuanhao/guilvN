...
public class TouchesHelper {
    ...
    public static final String PAGE_X_KEY = "pageX";
    public static final String PAGE_Y_KEY = "pageY";
    public static final String POINTER_IDENTIFIER_KEY = "identifier";
    ...
    public static WritableArray createsPointersArray(int i, TouchEvent touchEvent) {
