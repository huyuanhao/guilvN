...
public class AndroidPlatform extends Platform {
    ...
    public static final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
        ...
        public List<Certificate> clean(List<Certificate> list, String str) throws SSLPeerUnverifiedException {
            try {
                return (List) this.checkServerTrusted.invoke(this.x509TrustManagerExtensions, (X509Certificate[]) list.toArray(new X509Certificate[list.size()]), C7491o0OoOOO.OooO00o, str);
    ...
    public static final class CloseGuard {
        ...
        public static CloseGuard get() {
            ...
            try {
                ...
                method = cls.getMethod(ConnType.PK_OPEN, String.class);
