...
/* renamed from: com.pd.sdk.丨丨lLI  reason: invalid class name and case insensitive filesystem */
public class C9854lLI extends IIiLIli.OooO0O0 {
    public static final int OooOO0 = 6;
    public i11LI11I OooO00o = new i11LI11I(this, null, null);

    /* renamed from: com.pd.sdk.丨丨lLI$OooO00o */
    public class OooO00o implements AbstractC6100iILll {
        public final /* synthetic */ int OooO00o;

        /* renamed from: OooO00o  reason: collision with other field name */
        public final /* synthetic */ long[] f23471OooO00o;

        public OooO00o(int i, long[] jArr) {
            this.OooO00o = i;
            this.f23471OooO00o = jArr;
        }
        ...
        public AbstractC9738llL1L OooO00o(int i) {
            ...
            for (int i3 = 0; i3 < this.OooO00o; i3++) {
                ...
                for (int i4 = 0; i4 < 5; i4++) {
                    long j2 = OooO00o2[i4];
                    long[] jArr = this.f23471OooO00o;
                    OooO00o2[i4] = j2 ^ (jArr[i2 + i4] & j);
                    OooO00o3[i4] = OooO00o3[i4] ^ (jArr[(i2 + 5) + i4] & j);
                }
                i2 += 10;
            }
            return C9854lLI.this.OooO00o((AbstractC97441iIIL) new LIliIIiL(OooO00o2), (AbstractC97441iIIL) new LIliIIiL(OooO00o3), false);
        }
    }
    ...
    public C9854lLI() {
        ...
        ((IIiLIli) this).f15499OooO00o = new BigInteger(1, C6472l1l1l.OooO00o("01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE9AE2ED07577265DFF7F94451E061E163C61"));
