...
public class TouchEvent extends Event<TouchEvent> {
    public static final Pools.OooO0O0<TouchEvent> EVENTS_POOL = new Pools.OooO0O0<>(3);
    ...
    public static /* synthetic */ class C08571 {
        public static final /* synthetic */ int[] $SwitchMap$com$facebook$react$uimanager$events$TouchEventType;
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.react.uimanager.events.TouchEvent.C08571.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType = r0
            ...
            L_0x0012:
                int[] r0 = com.facebook.react.uimanager.events.TouchEvent.C08571.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.facebook.react.uimanager.events.TouchEvent.C08571.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.facebook.react.uimanager.events.TouchEvent.C08571.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.events.TouchEvent.C08571.<clinit>():void");
        }
    }
    ...
    public boolean canCoalesce() {
        int i = C08571.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType[((TouchEventType) Assertions.assertNotNull(this.mTouchEventType)).ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return false;
        }
        if (i == 4) {
