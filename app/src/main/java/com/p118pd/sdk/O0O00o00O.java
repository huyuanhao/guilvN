...
/* renamed from: com.pd.sdk.O0O00o00O */
public class O0O00o00O implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{94, 2, 68, 89, 66, 86, 111, 5, 66, 95, 89, 108, 90, 2, 70, 81}, "0c0043");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{83, 9, 7, 84, 86, 84, 1, 12, 4, 85, 82}, "281fef");
    public static O0O00o00O instance;

    public static O0O00o00O getInstance() {
        if (instance == null) {
            synchronized (O0O00o00O.class) {
                if (instance == null) {
                    instance = new O0O00o00O();
                }
            }
        }
        return instance;
