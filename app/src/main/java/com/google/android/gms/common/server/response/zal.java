...
public final class zal extends AbstractSafeParcelable {
    ...
    public final ArrayList<zam> zaqx;

    @SafeParcelable.Constructor
    public zal(@SafeParcelable.Param(mo10868id = 1) int i, @SafeParcelable.Param(mo10868id = 2) String str, @SafeParcelable.Param(mo10868id = 3) ArrayList<zam> arrayList) {
        this.versionCode = i;
        this.className = str;
        this.zaqx = arrayList;
    }
