...
public final class StringsKt__StringsKt$rangesDelimitedBy$4 extends Lambda implements O00Oo000<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>> {
    ...
    public final Pair<Integer, Integer> invoke(@NotNull CharSequence charSequence, int i) {
        ...
        Pair pair = StringsKt__StringsKt.OooO0O0(charSequence, (Collection<String>) this.$delimitersList, i, this.$ignoreCase, false);
        if (pair != null) {
            return C9163oooOOO0O.OooO00o(pair.getFirst(), Integer.valueOf(((String) pair.getSecond()).length()));
        }
        return null;
    }
}
