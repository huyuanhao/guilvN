...
public final class zzfm extends zzfl<zzfy.zze> {
    ...
    public final <UT, UB> UB zza(zzhv zzhv, Object obj, zzfk zzfk, zzfp<zzfy.zze> zzfp, UB ub, zzio<UT, UB> zzio) throws IOException {
        ...
        zzfy.zze zze = zzf.zzww;
        int i = zze.number;
        if (!zze.zzws || !zze.zzwt) {
            Object obj2 = null;
            zzjd zzjd = zzf.zzww.zzwr;
            if (zzjd != zzjd.ENUM) {
                switch (zzfn.zzrr[zzjd.ordinal()]) {
                    case 1:
            ...
            zzfy.zze zze2 = zzf.zzww;
            if (zze2.zzws) {
                zzfp.zzb(zze2, obj2);
            } else {
                int i2 = zzfn.zzrr[zze2.zzwr.ordinal()];
