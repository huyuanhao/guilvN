...
/* renamed from: com.pd.sdk.O00O00oO00 */
public class O00O00oO00 implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{8, 4, 18, 15, 19, 82, 57, 3, 20, 9, 8, 104, 12, 4, 16, 7}, "feffe7");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{85, 82, 82, 83, 7, 5, 7, 87, 81, 82, 3}, "4cda47");
    public static O00O00oO00 instance;

    public static O00O00oO00 getInstance() {
        if (instance == null) {
            synchronized (O00O00oO00.class) {
                if (instance == null) {
                    instance = new O00O00oO00();
                }
            }
        }
        return instance;
