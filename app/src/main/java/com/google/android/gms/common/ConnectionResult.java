...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo10865id = 2)
    public final int zzh;
    @SafeParcelable.Field(getter = "getResolution", mo10865id = 3)
    public final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getErrorMessage", mo10865id = 4)
    public final String zzj;

    @SafeParcelable.Constructor
    public ConnectionResult(@SafeParcelable.Param(mo10868id = 1) int i, @SafeParcelable.Param(mo10868id = 2) int i2, @SafeParcelable.Param(mo10868id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo10868id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzh)).add(C3617o.f9396y, this.zzi).add("message", this.zzj).toString();
    }
