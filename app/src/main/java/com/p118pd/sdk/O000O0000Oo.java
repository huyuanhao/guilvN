...
/* renamed from: com.pd.sdk.O000O0000Oo */
public class O000O0000Oo implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{8, 4, 22, 10, 69, 0, 57, 3, 16, 12, 94, 58, 12, 4, 20, 2}, "febc3e");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{3, 85, 83, 11, 82, 1, 81, 80, 80, 10, 86}, "bde9a3");
    public static O000O0000Oo instance;

    public static O000O0000Oo getInstance() {
        if (instance == null) {
            synchronized (O000O0000Oo.class) {
                if (instance == null) {
                    instance = new O000O0000Oo();
                }
            }
        }
        return instance;
