...
public class X509CertificateObject extends X509Certificate implements AbstractC6786llil {
    ...
    public ii1I11l bcHelper;

    /* renamed from: c */
    public LilIiIl f13494c;
    public int hashValue;
    public boolean hashValueSet;
    public boolean[] keyUsage;

    public X509CertificateObject(ii1I11l ii1i11l, LilIiIl lilIiIl) throws CertificateParsingException {
        this.bcHelper = ii1i11l;
        this.f13494c = lilIiIl;
        try {
    ...
    private void OooO00o(PublicKey publicKey, Signature signature) throws CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        if (OooO00o(this.f13494c.m16319OooO00o(), this.f13494c.OooO00o().m15516OooO00o())) {
            i1LLIL.OooO00o(signature, this.f13494c.m16319OooO00o().m17587OooO0O0());
    ...
    private byte[] OooO00o(String str) {
        C5237III OooO00o;
        iI11IL OooO00o2 = this.f13494c.OooO00o().m15514OooO00o();
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        if (date.getTime() > getNotAfter().getTime()) {
            throw new CertificateExpiredException("certificate expired on " + this.f13494c.m16316OooO00o().m15665OooO0O0());
        } else if (date.getTime() < getNotBefore().getTime()) {
            throw new CertificateNotYetValidException("certificate not valid till " + this.f13494c.m16322OooO0O0().m15665OooO0O0());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.hashValueSet || !x509CertificateObject.hashValueSet || this.hashValue == x509CertificateObject.hashValue) {
            return this.f13494c.equals(x509CertificateObject.f13494c);
        }
        return false;
    }
    ...
    public Set getCriticalExtensionOIDs() {
        ...
        iI11IL OooO00o = this.f13494c.OooO00o().m15514OooO00o();
        if (OooO00o == null) {
            return null;
        }
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        try {
            return this.f13494c.OooO00o(AbstractC5533IiL.OooO00o);
        } catch (IOException e) {
    ...
    public Principal getIssuerDN() {
        try {
            return new C6790lll1I11(l1LILI1.OooO00o(this.f13494c.m16318OooO00o().getEncoded()));
    ...
    public boolean[] getIssuerUniqueID() {
        iIilII1 OooO00o = this.f13494c.OooO00o().m15513OooO00o();
        if (OooO00o == null) {
            return null;
        }
    ...
    public X500Principal getIssuerX500Principal() {
        try {
            ...
            new C6103iIi1(byteArrayOutputStream).OooO00o(this.f13494c.m16318OooO00o());
    ...
    public Date getNotAfter() {
        return this.f13494c.m16316OooO00o().OooO00o();
    }

    public Date getNotBefore() {
        return this.f13494c.m16322OooO0O0().OooO00o();
    }

    public PublicKey getPublicKey() {
        try {
            return BouncyCastleProvider.getPublicKey(this.f13494c.m16321OooO00o());
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public BigInteger getSerialNumber() {
        return this.f13494c.m16320OooO00o().m17647OooO0O0();
    }

    public String getSigAlgName() {
        return i1LLIL.OooO00o(this.f13494c.m16319OooO00o());
    }

    public String getSigAlgOID() {
        return this.f13494c.m16319OooO00o().OooO00o().m16387OooO0O0();
    }

    public byte[] getSigAlgParams() {
        if (this.f13494c.m16319OooO00o().m17587OooO0O0() != null) {
            try {
                return this.f13494c.m16319OooO00o().m17587OooO0O0().OooO0O0().OooO00o(AbstractC5533IiL.OooO00o);
            } catch (IOException unused) {
            }
        }
        return null;
    ...
    public byte[] getSignature() {
        return this.f13494c.m16317OooO00o().OooO0O0();
    }
    ...
    public Principal getSubjectDN() {
        return new C6790lll1I11(l1LILI1.OooO00o(this.f13494c.m16324OooO0O0().OooO0O0()));
    }

    public boolean[] getSubjectUniqueID() {
        iIilII1 OooO0O0 = this.f13494c.OooO00o().m15520OooO0O0();
        if (OooO0O0 == null) {
            return null;
        }
    ...
    public X500Principal getSubjectX500Principal() {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            new C6103iIi1(byteArrayOutputStream).OooO00o(this.f13494c.m16324OooO0O0());
            return new X500Principal(byteArrayOutputStream.toByteArray());
        } catch (IOException unused) {
            throw new IllegalStateException("can't encode issuer DN");
        }
    ...
    public byte[] getTBSCertificate() throws CertificateEncodingException {
        try {
            return this.f13494c.OooO00o().OooO00o(AbstractC5533IiL.OooO00o);
        } catch (IOException e) {
            throw new CertificateEncodingException(e.toString());
        }
    }
    ...
    public int getVersion() {
        return this.f13494c.OooO0O0();
    }

    public boolean hasUnsupportedCriticalExtension() {
        iI11IL OooO00o;
        if (getVersion() != 3 || (OooO00o = this.f13494c.OooO00o().m15514OooO00o()) == null) {
            return false;
        }
        Enumeration OooO00o2 = OooO00o.OooO00o();
        while (OooO00o2.hasMoreElements()) {
            LlLI1 llLI1 = (LlLI1) OooO00o2.nextElement();
            if (!llLI1.equals(C5237III.o00OoOoo) && !llLI1.equals(C5237III.o00o000O) && !llLI1.equals(C5237III.o00o000o) && !llLI1.equals(C5237III.o00o00o0) && !llLI1.equals(C5237III.o00o000) && !llLI1.equals(C5237III.o00OoooO) && !llLI1.equals(C5237III.o0O00o0) && !llLI1.equals(C5237III.o00o00) && !llLI1.equals(C5237III.o00Ooo0o) && !llLI1.equals(C5237III.o00Ooo0) && !llLI1.equals(C5237III.o00o0000) && OooO00o.OooO00o(llLI1).m15434OooO00o()) {
                return true;
            }
        }
        return false;
    ...
    public final void verify(PublicKey publicKey) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature signature;
        String OooO00o = i1LLIL.OooO00o(this.f13494c.m16319OooO00o());
        try {
            signature = this.bcHelper.m17222OooO00o(OooO00o);
        } catch (Exception unused) {
