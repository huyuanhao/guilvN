...
public abstract class SuspendLambda extends ContinuationImpl implements o0O0O0O0<Object>, O000O {
    public final int arity;

    public SuspendLambda(int i, @Nullable AbstractC9282oooooO0<Object> oooooo0) {
        super(oooooo0);
        this.arity = i;
    }
