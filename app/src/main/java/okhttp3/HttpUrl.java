...
public final class HttpUrl {
    ...
    public static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i3 < i2) {
            ...
            oooo000.OooO00o(str, i, i3);
            canonicalize(oooo000, str, i3, i2, str2, z, z2, z3, z4, charset);
    ...
    public static final class Builder {
        ...
        private boolean isDot(String str) {
            return str.equals(C9058ooOoOoOO.OooOO0) || str.equalsIgnoreCase("%2e");
        }
        ...
        public Builder encodedPath(String str) {
            ...
            } else if (str.startsWith(C8932ooOOO0o.OooO0OO)) {
        ...
        public Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                if (i32 < delimiterOffset) {
                    ...
                    this.port = parsePort;
                    if (parsePort == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str.substring(i32, delimiterOffset) + C8318oOo0oooo.OooO00o);
                    }
                } else {
                    this.host = canonicalizeHost(str, i2, portColonOffset2);
                ...
                if (this.host != null) {
                    ...
                    throw new IllegalArgumentException("Invalid URL host: \"" + str.substring(i2, portColonOffset2) + C8318oOo0oooo.OooO00o);
                }
            } else {
    ...
    public static String percentDecode(String str, int i, int i2, boolean z) {
        for (int i3 = i; i3 < i2; i3++) {
            ...
            if (charAt == '%' || (charAt == '+' && z)) {
                OOOO000 oooo000 = new OOOO000();
                oooo000.OooO00o(str, i, i3);
                percentDecode(oooo000, str, i3, i2, z);
                return oooo000.m16606OooO0O0();
            }
        }
        return str.substring(i, i2);
    ...
    public static void canonicalize(OOOO000 oooo000, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        OOOO000 oooo0002 = null;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    oooo000.OooO00o(z ? "+" : "%2B");
                    ...
                    if (charset == null || charset.equals(Util.UTF_8)) {
                        ...
                        oooo0002.OooO00o(str, i, Character.charCount(codePointAt) + i, charset);
                    }
    ...
    public static void percentDecode(OOOO000 oooo000, String str, int i, int i2, boolean z) {
        int i3;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (codePointAt == 37 && (i3 = i + 2) < i2) {
                ...
                if (!(decodeHexDigit == -1 || decodeHexDigit2 == -1)) {
                    oooo000.OooO0o0((decodeHexDigit << 4) + decodeHexDigit2);
                    i = i3;
                    i += Character.charCount(codePointAt);
                }
