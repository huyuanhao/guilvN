...
public class StagingArea {
    ...
    private synchronized void logStats() {
        FLog.m894v(TAG, "Count = %d", Integer.valueOf(this.mMap.size()));
    }
    ...
    public synchronized boolean containsKey(CacheKey cacheKey) {
        ...
        synchronized (encodedImage) {
            ...
            FLog.m911w(TAG, "Found closed reference %d for key %s (%d)", Integer.valueOf(System.identityHashCode(encodedImage)), cacheKey.getUriString(), Integer.valueOf(System.identityHashCode(cacheKey)));
            return false;
        }
    }
    ...
    public synchronized com.facebook.imagepipeline.image.EncodedImage get(com.facebook.cache.common.CacheKey r7) {
        /*
            ...
            com.facebook.common.logging.FLog.m911w(r1, r2, r3)     // Catch:{ all -> 0x004c }
            r7 = 0
