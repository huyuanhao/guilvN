...
public class DebugOverlayController {
    ...
    public static boolean hasPermission(Context context, String str) {
        try {
            ...
            FLog.m874e(ReactConstants.TAG, "Error while retrieving package info", e);
        }
        return false;
    }
    ...
    public static void requestPermission(Context context) {
        if (Build.VERSION.SDK_INT >= 23 && !Settings.canDrawOverlays(context)) {
            ...
            FLog.m913w(ReactConstants.TAG, "Overlay permissions needs to be granted in order for react native apps to run in dev mode");
    ...
    public void setFpsDebugViewVisible(final boolean z) {
        UiThreadUtil.runOnUiThread(new Runnable() {
            /* class com.facebook.react.devsupport.DebugOverlayController.RunnableC06741 */
            ...
            public void run() {
                if (!z || DebugOverlayController.this.mFPSDebugViewContainer != null) {
                    ...
                    FLog.m861d(ReactConstants.TAG, "Wait for overlay permission to be set");
                } else {
