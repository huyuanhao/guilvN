...
public final class ServiceMethod<R, T> {
    ...
    public static final class Builder<T, R> {
        ...
        private RuntimeException parameterError(Throwable th, int i, String str, Object... objArr) {
            return methodError(th, str + " (parameter #" + (i + 1) + C3848l.f10402t, objArr);
        }
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        Headers of = Headers.m14261of("Content-Disposition", "form-data; name=\"" + value5 + "\"", "Content-Transfer-Encoding", part.encoding());
        ...
        private RuntimeException methodError(Throwable th, String str, Object... objArr) {
            ...
            return new IllegalArgumentException(format + "\n    for method " + this.method.getDeclaringClass().getSimpleName() + C9058ooOoOoOO.OooOO0 + this.method.getName(), th);
        }

        private RuntimeException parameterError(int i, String str, Object... objArr) {
            return methodError(str + " (parameter #" + (i + 1) + C3848l.f10402t, objArr);
        }
    }
    ...
    public Request toRequest(@Nullable Object... objArr) throws IOException {
        ...
        throw new IllegalArgumentException("Argument count (" + length + ") doesn't match expected count (" + parameterHandlerArr.length + C3848l.f10402t);
    }
