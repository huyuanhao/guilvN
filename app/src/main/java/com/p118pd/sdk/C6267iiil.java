...
public class C6267iiil extends IIiLIli.OooO0O0 {
    public static final int OooOO0 = 6;
    public LiL1lli OooO00o = new LiL1lli(this, null, null);

    /* renamed from: com.pd.sdk.iii丨l$OooO00o */
    public class OooO00o implements AbstractC6100iILll {
        public final /* synthetic */ int OooO00o;

        /* renamed from: OooO00o  reason: collision with other field name */
        public final /* synthetic */ long[] f17917OooO00o;

        public OooO00o(int i, long[] jArr) {
            this.OooO00o = i;
            this.f17917OooO00o = jArr;
        }
        ...
        public AbstractC9738llL1L OooO00o(int i) {
            ...
            for (int i3 = 0; i3 < this.OooO00o; i3++) {
                ...
                for (int i4 = 0; i4 < 3; i4++) {
                    long j2 = OooO00o2[i4];
                    long[] jArr = this.f17917OooO00o;
                    OooO00o2[i4] = j2 ^ (jArr[i2 + i4] & j);
                    OooO00o3[i4] = OooO00o3[i4] ^ (jArr[(i2 + 3) + i4] & j);
                }
                i2 += 6;
            }
            return C6267iiil.this.OooO00o((AbstractC97441iIIL) new C5354IiI(OooO00o2), (AbstractC97441iIIL) new C5354IiI(OooO00o3), false);
        }
    }

    public C6267iiil() {
        super(131, 2, 3, 8);
        ((IIiLIli) this).f15498OooO00o = OooO00o(new BigInteger(1, C6472l1l1l.OooO00o("07A11B09A76B562144418FF3FF8C2570B8")));
        ((IIiLIli) this).f15500OooO0O0 = OooO00o(new BigInteger(1, C6472l1l1l.OooO00o("0217C05610884B63B9C6C7291678F9D341")));
        ((IIiLIli) this).f15499OooO00o = new BigInteger(1, C6472l1l1l.OooO00o("0400000000000000023123953A9464B54D"));
