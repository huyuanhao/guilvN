...
public class WXApiImplComm {
    public static final String TAG = "MicroMsg.SDK.WXMsgImplComm";
    ...
    public static boolean validateAppSignature(Context context, Signature[] signatureArr, boolean z) {
        ...
        if (!z) {
            ...
            for (Signature signature : signatureArr) {
                ...
                Log.m8650d(TAG, "check signature:" + lowerCase);
    ...
    public static boolean validateAppSignatureForPackage(Context context, String str, boolean z) {
        if (!z) {
            Log.m8650d(TAG, "ignore wechat app signature validation");
            return true;
        }
        try {
