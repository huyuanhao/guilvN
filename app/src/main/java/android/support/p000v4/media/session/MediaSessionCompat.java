...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((C7236o00ooOoo.OooO0O0) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            C6990o000O0oo.OooO00o(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinder);
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(C7236o00ooOoo.OooO0O0 oooO0O0) {
            long j;
            if (this.mMediaPlayPauseKeyPending) {
                ...
                if (mediaSessionImpl != null) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo(oooO0O0);
                    if (z2 && z) {
                        onPause();
                    } else if (!z2 && z3) {
                        onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            C7236o00ooOoo.OooO0O0 currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        C7236o00ooOoo.OooO0O0 getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(C7236o00ooOoo.OooO0O0 oooO0O0);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        @Override // android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImpl, android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImplBase
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() {
                /* class android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImplApi18.C00221 */
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        @Override // android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImpl, android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImplApi18, android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImplBase
        public void setCallback(Callback callback, Handler handler) {
            super.setCallback(callback, handler);
            if (callback == null) {
            ...
            this.mRcc.setMetadataUpdateListener(new RemoteControlClient.OnMetadataUpdateListener() {
                /* class android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImplApi19.C00231 */
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        @NonNull
        public final C7236o00ooOoo.OooO0O0 getCurrentControllerInfo() {
            return new C7236o00ooOoo.OooO0O0(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(C7236o00ooOoo.OooO0O0 oooO0O0) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public C7236o00ooOoo.OooO0O0 mRemoteUserInfo;
        ...
        public VolumeProviderCompat.OooO0O0 mVolumeCallback = new VolumeProviderCompat.OooO0O0() {
            /* class android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImplBase.C00241 */

            @Override // androidx.media.VolumeProviderCompat.OooO0O0
            public void onVolumeChanged(VolumeProviderCompat volumeProviderCompat) {
                if (MediaSessionImplBase.this.mVolumeProvider == volumeProviderCompat) {
                    MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                    MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, volumeProviderCompat.OooO0OO(), volumeProviderCompat.OooO0O0(), volumeProviderCompat.OooO00o()));
                }
            }
        };
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    if (i == 2) {
                        int OooO0OO = volumeProviderCompat.OooO0OO();
                        int OooO0O0 = volumeProviderCompat.OooO0O0();
                        i3 = volumeProviderCompat.OooO00o();
                        i4 = OooO0O0;
                        i5 = OooO0OO;
                    } else {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new C7236o00ooOoo.OooO0O0(C7236o00ooOoo.OooO0O0.OooO00o, Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    MediaSessionImplBase.this.setCurrentControllerInfo(new C7236o00ooOoo.OooO0O0(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt("data_calling_pid"), data.getInt("data_calling_uid")));
        ...
        public void adjustVolume(int i, int i2) {
            if (this.mVolumeType == 2) {
                ...
                if (volumeProviderCompat != null) {
                    volumeProviderCompat.OooO00o(i);
                    return;
                }
                return;
            }
        ...
        @Override // android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImpl
        public C7236o00ooOoo.OooO0O0 getCurrentControllerInfo() {
            C7236o00ooOoo.OooO0O0 oooO0O0;
            synchronized (this.mLock) {
                oooO0O0 = this.mRemoteUserInfo;
            }
            return oooO0O0;
        }
        ...
        public void postToHandler(int i, int i2, int i3, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                if (this.mHandler != null) {
                    ...
                    Bundle bundle2 = new Bundle();
                    bundle2.putString(MediaSessionCompat.DATA_CALLING_PACKAGE, C7236o00ooOoo.OooO0O0.OooO00o);
        ...
        public void setPlaybackToLocal(int i) {
            VolumeProviderCompat volumeProviderCompat = this.mVolumeProvider;
            if (volumeProviderCompat != null) {
                volumeProviderCompat.OooO00o((VolumeProviderCompat.OooO0O0) null);
            }
            this.mLocalStream = i;
            this.mVolumeType = 1;
        ...
        public void setPlaybackToRemote(VolumeProviderCompat volumeProviderCompat) {
            if (volumeProviderCompat != null) {
                ...
                if (volumeProviderCompat2 != null) {
                    volumeProviderCompat2.OooO00o((VolumeProviderCompat.OooO0O0) null);
                }
                this.mVolumeType = 2;
                this.mVolumeProvider = volumeProviderCompat;
                sendVolumeInfoChanged(new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.OooO0OO(), this.mVolumeProvider.OooO0O0(), this.mVolumeProvider.OooO00o()));
                volumeProviderCompat.OooO00o(this.mVolumeCallback);
                return;
            }
        ...
        public void setVolumeTo(int i, int i2) {
            if (this.mVolumeType == 2) {
                VolumeProviderCompat volumeProviderCompat = this.mVolumeProvider;
                if (volumeProviderCompat != null) {
                    volumeProviderCompat.OooO0O0(i);
                    return;
                }
                return;
            }
    ...
    public static final class QueueItem implements Parcelable {
        public static final Parcelable.Creator<QueueItem> CREATOR = new Parcelable.Creator<QueueItem>() {
            /* class android.support.p000v4.media.session.MediaSessionCompat.QueueItem.C00251 */
    ...
    public static final class Token implements Parcelable {
        public static final Parcelable.Creator<Token> CREATOR = new Parcelable.Creator<Token>() {
            /* class android.support.p000v4.media.session.MediaSessionCompat.Token.C00271 */
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(C6990o000O0oo.OooO00o(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                C6990o000O0oo.OooO00o(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        public static final Parcelable.Creator<ResultReceiverWrapper> CREATOR = new Parcelable.Creator<ResultReceiverWrapper>() {
            /* class android.support.p000v4.media.session.MediaSessionCompat.ResultReceiverWrapper.C00261 */
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context == null) {
            ...
            componentName = componentName == null ? MediaButtonReceiver.OooO00o(context) : componentName;
            ...
            if (i >= 28) {
                ...
                setCallback(new Callback() {
                    /* class android.support.p000v4.media.session.MediaSessionCompat.C00191 */
                });
                this.mImpl.setMediaButtonReceiver(pendingIntent);
            } else if (i >= 21) {
                this.mImpl = new MediaSessionImplApi21(context, str, bundle);
                setCallback(new Callback() {
                    /* class android.support.p000v4.media.session.MediaSessionCompat.C00202 */
                });
                this.mImpl.setMediaButtonReceiver(pendingIntent);
            } else if (i >= 19) {
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                if (!mediaSessionImplApi21.mDestroyed) {
                    ...
                    if (callingPackage == null) {
                        callingPackage = C7236o00ooOoo.OooO0O0.OooO00o;
                    }
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new C7236o00ooOoo.OooO0O0(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        @Override // android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(VolumeProviderCompat volumeProviderCompat) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, volumeProviderCompat.m14692OooO00o());
        }
    ...
    public MediaSessionCompat(Context context, MediaSessionImpl mediaSessionImpl) {
        ...
        if (Build.VERSION.SDK_INT >= 21 && !MediaSessionCompatApi21.hasCallback(mediaSessionImpl.getMediaSession())) {
            setCallback(new Callback() {
                /* class android.support.p000v4.media.session.MediaSessionCompat.C00213 */
            });
        }
        this.mController = new MediaControllerCompat(context, this);
    }
