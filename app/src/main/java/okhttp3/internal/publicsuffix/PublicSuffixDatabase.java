...
public final class PublicSuffixDatabase {
    ...
    public static final byte[] WILDCARD_LABEL = {ExifInterface.OooO00o};
    ...
    private void readTheList() throws IOException {
        ...
        if (resourceAsStream != null) {
            oOOO000O OooO00o = C9143oooO0oOo.OooO00o(new oOOO0O00(C9143oooO0oOo.OooO00o(resourceAsStream)));
            try {
                byte[] bArr = new byte[OooO00o.readInt()];
                OooO00o.readFully(bArr);
                byte[] bArr2 = new byte[OooO00o.readInt()];
                OooO00o.readFully(bArr2);
                synchronized (this) {
