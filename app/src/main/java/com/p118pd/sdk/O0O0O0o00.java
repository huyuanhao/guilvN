...
/* renamed from: com.pd.sdk.O0O0O0o00 */
public class O0O0O0o00 implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{89, 4, 18, 92, 67, 84, 104, 3, 20, 90, 88, 110, 93, 4, 16, 84}, "7ef551");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{0, 2, 15, 81, 7, 87, 82, 7, 12, 80, 3}, "a39c4e");
    public static O0O0O0o00 instance;

    public static O0O0O0o00 getInstance() {
        if (instance == null) {
            synchronized (O0O0O0o00.class) {
                if (instance == null) {
                    instance = new O0O0O0o00();
                }
            }
        }
        return instance;
