...
public final class Hpack {
    ...
    public static final Header[] STATIC_HEADER_TABLE = {new Header(Header.TARGET_AUTHORITY, ""), new Header(Header.TARGET_METHOD, "GET"), new Header(Header.TARGET_METHOD, "POST"), new Header(Header.TARGET_PATH, C8932ooOOO0o.OooO0OO), new Header(Header.TARGET_PATH, "/index.html"), new Header(Header.TARGET_SCHEME, "http"), new Header(Header.TARGET_SCHEME, "https"), new Header(Header.RESPONSE_STATUS, "200"), new Header(Header.RESPONSE_STATUS, "204"), new Header(Header.RESPONSE_STATUS, "206"), new Header(Header.RESPONSE_STATUS, "304"), new Header(Header.RESPONSE_STATUS, "400"), new Header(Header.RESPONSE_STATUS, "404"), new Header(Header.RESPONSE_STATUS, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header("content-type", ""), new Header("cookie", ""), new Header(DatePickerDialogModule.ARG_DATE, ""), new Header("etag", ""), new Header("expect", ""), new Header("expires", ""), new Header("from", ""), new Header("host", ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header("location", ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header(C7546o0o000O0.o00000O0, ""), new Header("retry-after", ""), new Header("server", ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header(Http2Codec.TRANSFER_ENCODING, ""), new Header("user-agent", ""), new Header("vary", ""), new Header(SocializeProtocolConstants.PROTOCOL_KEY_VERIFY_MEDIA, ""), new Header("www-authenticate", "")};
    ...
    public static final class Reader {
        ...
        public Reader(int i, AbstractC8930ooOOO0OO ooooo0oo) {
            this(i, i, ooooo0oo);
        }
        ...
        public ByteString readByteString() throws IOException {
            ...
            if (z) {
                return ByteString.m14263of(Huffman.get().decode(this.source.m19762OooO00o((long) readInt)));
            }
            return this.source.m19757OooO00o((long) readInt);
        }

        public void readHeaders() throws IOException {
            while (!this.source.m19766OooO0OO()) {
        ...
        public Reader(int i, int i2, AbstractC8930ooOOO0OO ooooo0oo) {
            ...
            this.source = C9143oooO0oOo.OooO00o(ooooo0oo);
        }
    }
    ...
    public static final class Writer {
        ...
        public void writeByteString(ByteString byteString) throws IOException {
            if (!this.useCompression || Huffman.get().encodedLength(byteString) >= byteString.size()) {
                ...
                this.out.OooO00o(byteString);
                return;
            }
            OOOO000 oooo000 = new OOOO000();
            Huffman.get().encode(byteString, oooo000);
            ByteString OooO00o = oooo000.m16595OooO00o();
            writeInt(OooO00o.size(), 127, 128);
            this.out.OooO00o(OooO00o);
        }
        ...
        public void writeInt(int i, int i2, int i3) {
            if (i < i2) {
                this.out.OooO0o0(i | i3);
                return;
            }
            this.out.OooO0o0(i3 | i2);
            int i4 = i - i2;
            while (i4 >= 128) {
                this.out.OooO0o0(128 | (i4 & 127));
                i4 >>>= 7;
            }
            this.out.OooO0o0(i4);
        }

        public Writer(int i, boolean z, OOOO000 oooo000) {
            this.smallestHeaderTableSizeSetting = Integer.MAX_VALUE;
            Header[] headerArr = new Header[8];
            this.dynamicTable = headerArr;
            this.nextHeaderIndex = headerArr.length - 1;
