...
public class C6299ilI {
    ...
    public static boolean m17331OooO00o(long[] jArr, long[] jArr2) {
    ...
    public static void OooO0O0(long[] jArr, long[] jArr2) {
        ...
        long j3 = jArr[2];
        long j4 = jArr[3];
        jArr2[0] = ((j4 >> 63) & i1Iiiil.OooO0OO) ^ (j << 1);
        jArr2[1] = (j >>> 63) | (j2 << 1);
        jArr2[2] = (j3 << 1) | (j2 >>> 63);
        jArr2[3] = (j4 << 1) | (j3 >>> 63);
    }
