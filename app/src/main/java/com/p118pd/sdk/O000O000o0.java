...
/* renamed from: com.pd.sdk.O000O000o0 */
public class O000O000o0 implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{88, 88, 70, 10, 79, 92, 105, 95, 64, 12, 84, 102, 92, 88, 68, 2}, "692c99");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{84, 83, 85, 80, 80, 11, 6, 86, 86, 81, 84}, "5bcbc9");
    public static O000O000o0 instance;

    public static O000O000o0 getInstance() {
        if (instance == null) {
            synchronized (O000O000o0.class) {
                if (instance == null) {
                    instance = new O000O000o0();
                }
            }
        }
        return instance;
