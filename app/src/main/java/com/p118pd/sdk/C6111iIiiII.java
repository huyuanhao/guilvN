...
/* renamed from: com.pd.sdk.iIiiI丨丨I  reason: invalid class name and case insensitive filesystem */
public class C6111iIiiII extends IIiLIli.OooO0O0 {
    public static final int OooOO0 = 6;
    public C6449l1LII OooO00o = new C6449l1LII(this, null, null);

    /* renamed from: com.pd.sdk.iIiiI丨丨I$OooO00o */
    public class OooO00o implements AbstractC6100iILll {
        public final /* synthetic */ int OooO00o;

        /* renamed from: OooO00o  reason: collision with other field name */
        public final /* synthetic */ long[] f17571OooO00o;

        public OooO00o(int i, long[] jArr) {
            this.OooO00o = i;
            this.f17571OooO00o = jArr;
        }
        ...
        public AbstractC9738llL1L OooO00o(int i) {
            ...
            for (int i3 = 0; i3 < this.OooO00o; i3++) {
                ...
                for (int i4 = 0; i4 < 2; i4++) {
                    long j2 = OooO00o2[i4];
                    long[] jArr = this.f17571OooO00o;
                    OooO00o2[i4] = j2 ^ (jArr[i2 + i4] & j);
                    OooO00o3[i4] = OooO00o3[i4] ^ (jArr[(i2 + 2) + i4] & j);
                }
                i2 += 4;
            }
            return C6111iIiiII.this.OooO00o((AbstractC97441iIIL) new LIi1lli1(OooO00o2), (AbstractC97441iIIL) new LIi1lli1(OooO00o3), false);
        }
    }

    public C6111iIiiII() {
        super(113, 9, 0, 0);
        ((IIiLIli) this).f15498OooO00o = OooO00o(new BigInteger(1, C6472l1l1l.OooO00o("003088250CA6E7C7FE649CE85820F7")));
        ((IIiLIli) this).f15500OooO0O0 = OooO00o(new BigInteger(1, C6472l1l1l.OooO00o("00E8BEE4D3E2260744188BE0E9C723")));
        ((IIiLIli) this).f15499OooO00o = new BigInteger(1, C6472l1l1l.OooO00o("0100000000000000D9CCEC8A39E56F"));
