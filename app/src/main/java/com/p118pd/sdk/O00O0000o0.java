...
/* renamed from: com.pd.sdk.O00O0000o0 */
public class O00O0000o0 implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{92, 86, 76, 91, 19, 0, 109, 81, 74, 93, 8, 58, 88, 86, 78, 83}, "2782ee");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{3, 1, 87, 83, 5, 7, 81, 4, 84, 82, 1}, "b0aa65");
    public static O00O0000o0 instance;

    public static O00O0000o0 getInstance() {
        if (instance == null) {
            synchronized (O00O0000o0.class) {
                if (instance == null) {
                    instance = new O00O0000o0();
                }
            }
        }
        return instance;
