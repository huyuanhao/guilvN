...
public final class zzhl<T> implements zzhw<T> {
    ...
    public static <T> zzhl<T> zza(zzio<?, ?> zzio, zzfl<?> zzfl, zzhf zzhf) {
    ...
    public final void zza(T t, byte[] bArr, int i, int i2, zzei zzei) throws IOException {
        ...
        while (i < i2) {
            ...
            if (i3 == 11) {
                ...
                if (zzeo != null) {
                    zzip.zzb((i4 << 3) | 2, zzeo);
                }
                i = zza;
            } else if ((i3 & 7) == 2) {
                i = zzeh.zza(i3, bArr, zza, i2, zzip, zzei);
            } else {
