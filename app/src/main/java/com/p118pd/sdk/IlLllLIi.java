...
/* renamed from: com.pd.sdk.IlLllLIi */
public class IlLllLIi extends AbstractC5738Lil {
    ...
    public IlLllLIi(int i, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5) {
        this.o00oO0O = i;
    ...
    public static IlLllLIi OooO00o(Object obj) {
        if (obj instanceof IlLllLIi) {
            return (IlLllLIi) obj;
        }
        if (obj != null) {
            return new IlLllLIi(I11li1.OooO00o(obj));
        }
        return null;
    }
    ...
    public AbstractC6122iIlLiL m15676OooO0O0() {
