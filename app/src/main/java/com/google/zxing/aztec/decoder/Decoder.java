...
public final class Decoder {
    public static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", "2", "3", "4", "5", "6", MsgConstant.MESSAGE_NOTIFY_ARRIVAL, "8", "9", Constants.ACCEPT_TIME_SEPARATOR_SP, C9058ooOoOoOO.OooOO0, "CTRL_UL", "CTRL_US"};
    public static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", C2756c.f5722a, "d", "e", "f", "g", "h", C3617o.f9367au, "j", "k", "l", C7031o000oo0O.OooO0O0, GoogleApiAvailabilityLight.TRACKING_SOURCE_NOTIFICATION, "o", C3617o.f9365as, "q", "r", C3617o.f9366at, "t", "u", DispatchConstants.VERSION, "w", FontMetricsUtil.X_HEIGHT_MEASUREMENT_TEXT, "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    public static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", "|", Constants.WAVE_SEPARATOR, "", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    public static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", C3848l.f10401s, C3848l.f10402t, "*", "+", Constants.ACCEPT_TIME_SEPARATOR_SP, Constants.ACCEPT_TIME_SEPARATOR_SERVER, C9058ooOoOoOO.OooOO0, C8932ooOOO0o.OooO0OO, Constants.COLON_SEPARATOR, C7522o0Ooo0o.OooO0O0, "<", C8932ooOOO0o.OooO0Oo, ">", C8932ooOOO0o.f22176OooO00o, "[", "]", "{", C7522o0Ooo0o.OooO0Oo, "CTRL_UL"};
    public static final String[] UPPER_TABLE = {"CTRL_PS", " ", ExifInterface.o000oo0O, "B", "C", "D", ExifInterface.o000oo00, "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", "P", "Q", "R", ExifInterface.o000oOoo, "T", "U", ExifInterface.o000oo0o, ExifInterface.o000oo0, "X", "Y", "Z", "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    public AztecDetectorResult ddata;

    /* renamed from: com.google.zxing.aztec.decoder.Decoder$1 */
    public static /* synthetic */ class C10641 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.google.zxing.aztec.decoder.Decoder.C10641.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table = r0
            ...
            L_0x0012:
                int[] r0 = com.google.zxing.aztec.decoder.Decoder.C10641.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.google.zxing.aztec.decoder.Decoder.C10641.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.google.zxing.aztec.decoder.Decoder.C10641.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = com.google.zxing.aztec.decoder.Decoder.C10641.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C10641.<clinit>():void");
        }
    }
    ...
    public static String getCharacter(Table table, int i) {
        int i2 = C10641.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
