...
public final class PDF417 {
    ...
    public static final float DEFAULT_MODULE_WIDTH = 0.357f;
    public static final float HEIGHT = 2.0f;
    public static final float PREFERRED_RATIO = 3.0f;
    public static final int START_PATTERN = 130728;
    public static final int STOP_PATTERN = 260649;
    ...
    private int[] determineDimensions(int i, int i2) throws WriterException {
        ...
        while (i4 <= this.maxCols && (calculateNumberOfRows = calculateNumberOfRows(i, i2, i4)) >= this.minRows) {
            if (calculateNumberOfRows <= this.maxRows) {
                float f2 = (((float) ((i4 * 17) + 69)) * 0.357f) / (((float) calculateNumberOfRows) * 2.0f);
