...
/* renamed from: com.pd.sdk.丨1丨丨I1丨  reason: invalid class name and case insensitive filesystem */
public class C93231I1 extends X509CRLEntry {
    public l1LILI1 OooO00o;

    /* renamed from: OooO00o  reason: collision with other field name */
    public C6782lli11.OooO0O0 f22830OooO00o;
    public boolean OooO0O0;
    public int o00oO0O;

    public C93231I1(C6782lli11.OooO0O0 oooO0O0) {
        this.f22830OooO00o = oooO0O0;
        this.OooO00o = null;
    }

    public C93231I1(C6782lli11.OooO0O0 oooO0O0, boolean z, l1LILI1 r3) {
        this.f22830OooO00o = oooO0O0;
        this.OooO00o = OooO00o(z, r3);
    }

    private C5237III OooO00o(LlLI1 llLI1) {
        iI11IL OooO00o2 = this.f22830OooO00o.m17909OooO00o();
        if (OooO00o2 != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof C93231I1 ? this.f22830OooO00o.equals(((C93231I1) obj).f22830OooO00o) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f22830OooO00o.OooO00o(AbstractC5533IiL.OooO00o);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f22830OooO00o.OooO00o().OooO00o();
    }

    public BigInteger getSerialNumber() {
        return this.f22830OooO00o.m17910OooO00o().m17647OooO0O0();
    }

    public boolean hasExtensions() {
        return this.f22830OooO00o.m17909OooO00o() != null;
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(OooO00o3);
        iI11IL OooO00o4 = this.f22830OooO00o.m17909OooO00o();
        if (OooO00o4 != null) {
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            if (OooO00o6.m15433OooO00o() != null) {
                                ...
                                stringBuffer.append(") ");
                                try {
                                    if (llLI1.equals(C5237III.o00OooO)) {
