...
/* renamed from: com.huawei.hms.core.aidl.g */
public class C1153g extends C1152f {
    @Override // com.huawei.hms.core.aidl.C1152f
    /* renamed from: a */
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (obj.getClass().isPrimitive() || (obj instanceof String) || (obj instanceof Serializable)) {
                ...
                if (i3 == 1) {
                    ...
                    arrayList.add(mo15451a(bundle2, (IMessageEntity) ((Class) ((ParameterizedType) type).getActualTypeArguments()[0]).newInstance()));
                } else {
    ...
    public void mo15454a(String str, List list, Bundle bundle) {
        ...
        for (int i = 0; i < list.size(); i++) {
            mo15453a("_list_item_" + i, list.get(i), bundle2);
        }
