...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    public boolean verifyHostname(String str, String str2) {
        if (str != null && str.length() != 0 && !str.startsWith(C9058ooOoOoOO.OooOO0) && !str.endsWith("..") && str2 != null && str2.length() != 0 && !str2.startsWith(C9058ooOoOoOO.OooOO0) && !str2.endsWith("..")) {
            if (!str.endsWith(C9058ooOoOoOO.OooOO0)) {
                str = str + '.';
            }
            if (!str2.endsWith(C9058ooOoOoOO.OooOO0)) {
                str2 = str2 + '.';
            }
