    ...
    public static String processFixedAI(int i, int i2, String str) throws NotFoundException {
        if (str.length() >= i) {
            ...
            if (str.length() >= i3) {
                ...
                String str2 = C3848l.f10401s + substring + ')' + substring2;
