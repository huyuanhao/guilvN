...
public class ViewUtil {
    ...
    public static void OooO0O0(View view, String str, String str2, String str3, String str4) {
        ...
        view.setPadding(m22076OooO00o(str, context), m22076OooO00o(str2, context), m22076OooO00o(str3, context), m22076OooO00o(str4, context));
    }
    ...
    public static Map<String, Integer> m22078OooO00o() {
    ...
    public static boolean OooO0O0() {
        if (OooO00o == null) {
            OooO00o = Boolean.valueOf(m22080OooO00o());
        }
        return OooO00o.booleanValue();
    }

    /* renamed from: OooO00o  reason: collision with other method in class */
    public static int m22076OooO00o(String str, Context context) {
        if (str == null) {
            return 0;
        }
    ...
    public static float OooO00o(String str, Context context) {
        ...
        if (f23813OooO00o.containsKey(lowerCase)) {
            return f23813OooO00o.get(lowerCase).floatValue();
        }
        Matcher matcher = f23815OooO00o.matcher(lowerCase);
        if (matcher.matches()) {
            float parseFloat = Float.parseFloat(matcher.group(1));
            Integer num = f23814OooO00o.get(matcher.group(3).toLowerCase());
            if (num == null) {
                num = 1;
            }
            float applyDimension = TypedValue.applyDimension(num.intValue(), parseFloat, context.getResources().getDisplayMetrics());
            f23813OooO00o.put(lowerCase, Float.valueOf(applyDimension));
    ...
    public static void OooO00o(View view, String str, String str2, String str3, String str4) {
        ...
        if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
            ((ViewGroup.MarginLayoutParams) layoutParams).setMargins(m22076OooO00o(str, context), m22076OooO00o(str2, context), m22076OooO00o(str3, context), m22076OooO00o(str4, context));
        }
    }
    ...
    /* renamed from: OooO00o  reason: collision with other method in class */
    public static Bitmap m22077OooO00o(String str, Context context) {
    ...
    public static boolean OooO00o(Context context) {
        return !f23816OooO00o && context.getPackageManager().hasSystemFeature("android.hardware.camera.flash");
    }

    public static String OooO00o(ResolveInfo resolveInfo, Class cls) {
        if (resolveInfo == null) {
            return String.format("Didn't find %s in the AndroidManifest.xml", cls.getName());
        } else if (OooO00o(resolveInfo.activityInfo.configChanges, 128)) {
            return null;
        } else {
            return cls.getName() + " requires attribute android:configChanges=\"orientation\"";
        }
    }

    /* renamed from: OooO00o  reason: collision with other method in class */
    public static boolean m22080OooO00o() {
        boolean z;
        Log.i("excardrec.jar", "Checking hardware support...");
        ...
        try {
            ...
            String str = "- Error opening camera: " + e;
    ...
    /* renamed from: OooO00o  reason: collision with other method in class */
    public static void m22079OooO00o() {
        String str = "Native memory stats: " + OooO00o();
    }
