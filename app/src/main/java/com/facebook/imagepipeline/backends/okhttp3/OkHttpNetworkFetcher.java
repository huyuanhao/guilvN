...
public class OkHttpNetworkFetcher extends BaseNetworkFetcher<OkHttpNetworkFetchState> {
    ...
    public void fetchWithRequest(final OkHttpNetworkFetchState okHttpNetworkFetchState, final NetworkFetcher.Callback callback, Request request) {
        ...
        okHttpNetworkFetchState.getContext().addCallbacks(new BaseProducerContextCallbacks() {
            /* class com.facebook.imagepipeline.backends.okhttp3.OkHttpNetworkFetcher.C04961 */
            ...
            public void onCancellationRequested() {
                if (Looper.myLooper() != Looper.getMainLooper()) {
                    ...
                    OkHttpNetworkFetcher.this.mCancellationExecutor.execute(new Runnable() {
                        /* class com.facebook.imagepipeline.backends.okhttp3.OkHttpNetworkFetcher.C04961.RunnableC04971 */
        ...
        newCall.enqueue(new Callback() {
            /* class com.facebook.imagepipeline.backends.okhttp3.OkHttpNetworkFetcher.C04982 */
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (!(fromContentRangeHeader == null || (fromContentRangeHeader.from == 0 && fromContentRangeHeader.f964to == Integer.MAX_VALUE))) {
