...
public class ViewProps {
    ...
    public static final HashSet<String> LAYOUT_ONLY_PROPS = new HashSet<>(Arrays.asList(ALIGN_SELF, ALIGN_ITEMS, COLLAPSABLE, FLEX, FLEX_BASIS, FLEX_DIRECTION, FLEX_GROW, FLEX_SHRINK, FLEX_WRAP, JUSTIFY_CONTENT, ALIGN_CONTENT, DISPLAY, "position", "right", "top", "bottom", "left", START, END, "width", "height", MIN_WIDTH, MAX_WIDTH, MIN_HEIGHT, MAX_HEIGHT, MARGIN, MARGIN_VERTICAL, MARGIN_HORIZONTAL, MARGIN_LEFT, MARGIN_RIGHT, MARGIN_TOP, MARGIN_BOTTOM, MARGIN_START, MARGIN_END, PADDING, PADDING_VERTICAL, PADDING_HORIZONTAL, PADDING_LEFT, PADDING_RIGHT, PADDING_TOP, PADDING_BOTTOM, PADDING_START, PADDING_END));
    ...
    /* renamed from: ON */
    public static final String f984ON = "on";
    ...
    public static boolean isLayoutOnly(ReadableMap readableMap, String str) {
        ...
        switch (c) {
            ...
            case 1:
                ...
                if (!readableMap.hasKey(BORDER_WIDTH) || readableMap.isNull(BORDER_WIDTH) || readableMap.getDouble(BORDER_WIDTH) == AbstractC8352oOoOOoO0.OooO0O0) {
                    return true;
                }
                return false;
            case 2:
                if (readableMap.getInt(BORDER_LEFT_COLOR) == 0) {
                    return true;
                }
                return false;
            case 3:
                if (readableMap.getInt(BORDER_RIGHT_COLOR) == 0) {
                    return true;
                }
                return false;
            case 4:
                if (readableMap.getInt(BORDER_TOP_COLOR) == 0) {
                    return true;
                }
                return false;
            case 5:
                if (readableMap.getInt(BORDER_BOTTOM_COLOR) == 0) {
                    return true;
                }
                return false;
            case 6:
                if (readableMap.isNull(BORDER_WIDTH) || readableMap.getDouble(BORDER_WIDTH) == AbstractC8352oOoOOoO0.OooO0O0) {
                    return true;
                }
                return false;
            case 7:
                if (readableMap.isNull(BORDER_LEFT_WIDTH) || readableMap.getDouble(BORDER_LEFT_WIDTH) == AbstractC8352oOoOOoO0.OooO0O0) {
                    return true;
                }
                return false;
            case '\b':
                if (readableMap.isNull(BORDER_TOP_WIDTH) || readableMap.getDouble(BORDER_TOP_WIDTH) == AbstractC8352oOoOOoO0.OooO0O0) {
                    return true;
                }
                return false;
            case '\t':
                if (readableMap.isNull(BORDER_RIGHT_WIDTH) || readableMap.getDouble(BORDER_RIGHT_WIDTH) == AbstractC8352oOoOOoO0.OooO0O0) {
                    return true;
                }
                return false;
            case '\n':
                if (readableMap.isNull(BORDER_BOTTOM_WIDTH) || readableMap.getDouble(BORDER_BOTTOM_WIDTH) == AbstractC8352oOoOOoO0.OooO0O0) {
                    return true;
                }
                return false;
            case 11:
