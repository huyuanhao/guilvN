...
public class C5921O00O000o implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{90, 7, 17, 10, C8027oOO00oo.OooO0O0, 6, 107, 0, 23, 12, 92, 60, 94, 7, 19, 2}, "4fec1c");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{5, 3, 87, 3, 4, 80, 87, 6, 84, 2, 0}, "d2a17b");
    public static C5921O00O000o instance;

    public static C5921O00O000o getInstance() {
        if (instance == null) {
            synchronized (C5921O00O000o.class) {
                if (instance == null) {
                    instance = new C5921O00O000o();
                }
            }
        }
        return instance;
