...
/* renamed from: com.pd.sdk.II丨l丨ill  reason: invalid class name */
public class IIlill {
    public static final long OooO00o = 2199023255551L;
    ...
    public static void m15448OooO00o(long[] jArr) {
        long j = jArr[0];
        long j2 = jArr[1];
        long j3 = jArr[2];
        long j4 = jArr[3];
    ...
    public static void OooO0Oo(long[] jArr, long[] jArr2) {
        if (!C1LLlIL.OooO0O0(jArr)) {
            ...
            OooO0Oo(OooO00o2, OooO00o3, OooO00o2);
            OooO00o(OooO00o2, 58, OooO00o3);
            OooO0Oo(OooO00o3, OooO00o2, OooO00o3);
            OooO00o(OooO00o3, 116, OooO00o2);
            OooO0Oo(OooO00o2, OooO00o3, OooO00o2);
    ...
    public static void OooO0o(long[] jArr, long[] jArr2) {
        ...
        long j4 = (OooO0O04 >>> 32) | (-4294967296L & OooO0O05);
        long j5 = j4 >>> 27;
        long j6 = j4 ^ ((j2 >>> 27) | (j4 << 37));
        long j7 = j2 ^ (j2 << 37);
        long[] OooO0O06 = C1LLlIL.m21853OooO0O0();
        int[] iArr = {32, 117, Lillilli.OooooOo};
        int i = 0;
        for (int i2 = 3; i < i2; i2 = 3) {
            int i3 = iArr[i] >>> 6;
            int i4 = iArr[i] & 63;
            OooO0O06[i3] = OooO0O06[i3] ^ (j7 << i4);
            int i5 = i3 + 1;
            int i6 = -i4;
            OooO0O06[i5] = OooO0O06[i5] ^ ((j6 << i4) | (j7 >>> i6));
            int i7 = i3 + 2;
            OooO0O06[i7] = OooO0O06[i7] ^ ((j5 << i4) | (j6 >>> i6));
            int i8 = i3 + 3;
            OooO0O06[i8] = OooO0O06[i8] ^ (j5 >>> i6);
            i++;
        }
