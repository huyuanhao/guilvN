...
/* renamed from: com.pd.sdk.O000O0O0ooO */
public class O000O0O0ooO implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{8, 4, 77, 88, 20, 84, 57, 3, 75, 94, 15, 110, 12, 4, 79, 80}, "fe91b1");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{86, 8, 0, 5, 3, 3, 4, 13, 3, 4, 7}, "796701");
    public static O000O0O0ooO instance;

    public static O000O0O0ooO getInstance() {
        if (instance == null) {
            synchronized (O000O0O0ooO.class) {
                if (instance == null) {
                    instance = new O000O0O0ooO();
                }
            }
        }
        return instance;
