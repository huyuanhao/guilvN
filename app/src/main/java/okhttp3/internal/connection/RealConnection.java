...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = C9143oooO0oOo.OooO00o(C9143oooO0oOo.m20889OooO00o(this.rawSocket));
                this.sink = C9143oooO0oOo.OooO00o(C9143oooO0oOo.m20887OooO00o(this.rawSocket));
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            AbstractC8930ooOOO0OO newFixedLengthSource = http1Codec.newFixedLengthSource(contentLength);
            ...
            } else if (this.source.m19754OooO00o().m16616OooO0OO() && this.sink.OooO00o().m16616OooO0OO()) {
                return null;
            } else {
    ...
    private Request createTunnelRequest() throws IOException {
        Request build = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header(HttpConstant.HOST, Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header("User-Agent", Version.userAgent()).build();
    ...
    public RealWebSocket.Streams newWebSocketStreams(final StreamAllocation streamAllocation) {
        return new RealWebSocket.Streams(true, this.source, this.sink) {
            /* class okhttp3.internal.connection.RealConnection.C47711 */
