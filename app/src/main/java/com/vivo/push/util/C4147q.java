...
public final class C4147q {
    /* renamed from: a */
    public static UPSNotificationMessage m11219a(InsideNotificationItem insideNotificationItem) {
    ...
    /* renamed from: b */
    public static String m11220b(InsideNotificationItem insideNotificationItem) {
    ...
    /* renamed from: a */
    public static InsideNotificationItem m11218a(String str) {
        InsideNotificationItem insideNotificationItem = new InsideNotificationItem();
        try {
            if (TextUtils.isEmpty(str)) {
                C4146p.m11204a("MessageConvertUtil", "notify msg pack to obj is null");
                return null;
            }
            ...
            if (jSONArray.length() > 11) {
                insideNotificationItem.setParams(C4143m.m11177a(new JSONObject(jSONArray.getString(11))));
            }
            ...
            C4146p.m11205a("MessageConvertUtil", "notify msg pack to obj error", e);
        }
    }
}
