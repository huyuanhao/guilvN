...
/* renamed from: com.pd.sdk.O00O00oooo0 */
public class O00O00oooo0 implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{94, 85, 66, 12, 19, 3, 111, 82, 68, 10, 8, 57, 90, 85, 64, 4}, "046eef");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{88, 80, 7, 6, 86, 1, 10, 85, 4, 7, 82}, "9a14e3");
    public static O00O00oooo0 instance;

    public static O00O00oooo0 getInstance() {
        if (instance == null) {
            synchronized (O00O00oooo0.class) {
                if (instance == null) {
                    instance = new O00O00oooo0();
                }
            }
        }
        return instance;
