...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWidth", mo10865id = 3)
    public final int zand;
    @SafeParcelable.Field(getter = "getHeight", mo10865id = 4)
    public final int zane;
    @SafeParcelable.Field(getter = "getUrl", mo10865id = 2)
    public final Uri zanf;

    @SafeParcelable.Constructor
    public WebImage(@SafeParcelable.Param(mo10868id = 1) int i, @SafeParcelable.Param(mo10868id = 2) Uri uri, @SafeParcelable.Param(mo10868id = 3) int i2, @SafeParcelable.Param(mo10868id = 4) int i3) {
        this.zale = i;
        this.zanf = uri;
        this.zand = i2;
        this.zane = i3;
