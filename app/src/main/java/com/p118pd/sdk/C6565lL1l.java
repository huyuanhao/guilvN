...
/* renamed from: com.pd.sdk.lL1丨l丨丨  reason: invalid class name and case insensitive filesystem */
public class C6565lL1l extends AbstractC6446l1IlIlI {
    ...
    public PrivateKey OooO00o(C5464IlilIi r4) throws IOException {
        ...
        if (OooO00o.equals(AbstractC5331ILi.OooOOO0)) {
            return new BCECGOST3410PrivateKey(r4);
        }
        if (OooO00o.equals(AbstractC5331ILi.Oooo000)) {
            return new BCECGOST3410PrivateKey(r4);
        }
        if (OooO00o.equals(AbstractC5331ILi.OooOooo)) {
            return new BCECGOST3410PrivateKey(r4);
        }
    ...
    public PublicKey OooO00o(C6888ll r4) throws IOException {
        ...
        if (OooO00o.equals(AbstractC5331ILi.OooOOO0)) {
            return new BCECGOST3410PublicKey(r4);
        }
        if (OooO00o.equals(AbstractC5331ILi.Oooo000)) {
            return new BCECGOST3410PublicKey(r4);
        }
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof IL1IIl ? new BCECGOST3410PrivateKey((IL1IIl) keySpec) : keySpec instanceof ECPrivateKeySpec ? new BCECGOST3410PrivateKey((ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }

    @Override // java.security.KeyFactorySpi, com.p118pd.sdk.AbstractC6446l1IlIlI
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof C5769Ll1 ? new BCECGOST3410PublicKey((C5769Ll1) keySpec, BouncyCastleProvider.CONFIGURATION) : keySpec instanceof ECPublicKeySpec ? new BCECGOST3410PublicKey((ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
