...
/* renamed from: com.pd.sdk.O00O000o00 */
public class O00O000o00 implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{93, 85, 18, 91, 67, 85, 108, 82, 20, 93, 88, 111, 89, 85, 16, 83}, "34f250");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{5, 7, 5, 4, 4, 4, 87, 2, 6, 5, 0}, "d63676");
    public static O00O000o00 instance;

    public static O00O000o00 getInstance() {
        if (instance == null) {
            synchronized (O00O000o00.class) {
                if (instance == null) {
                    instance = new O00O000o00();
                }
            }
        }
        return instance;
