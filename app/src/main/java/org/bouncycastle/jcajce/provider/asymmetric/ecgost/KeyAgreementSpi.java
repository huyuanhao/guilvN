...
import com.p118pd.sdk.C6846lLIlii;
...
public class KeyAgreementSpi extends AbstractC5549Ii1 {
    ...
    public C5179I1iLL f23923OooO00o;

    /* renamed from: OooO00o  reason: collision with other field name */
    public C5600L1iLL f23924OooO00o;
    public String OooO0O0;

    /* renamed from: OooO0O0  reason: collision with other field name */
    public byte[] f23925OooO0O0;

    public static class OooO00o extends KeyAgreementSpi {
        public OooO00o() {
            super("ECGOST3410", new C5179I1iLL(new C6846lLIlii()), null);
        }
    }
    ...
    public KeyAgreementSpi(String str, C5179I1iLL r2, AbstractC6427ii r3) {
        super(str, r3);
        this.OooO0O0 = str;
        this.f23923OooO00o = r2;
    }

    public static C6213iL11I OooO00o(PublicKey publicKey) throws InvalidKeyException {
        return publicKey instanceof BCECPublicKey ? ((BCECGOST3410PublicKey) publicKey).engineGetKeyParameters() : IlllII1.OooO00o(publicKey);
    }
    ...
    private void OooO00o(Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
        if (key instanceof PrivateKey) {
            ...
            this.f23923OooO00o.OooO00o((AbstractC6370iIIIl) new C6403ii(r3, OooO00o2));
            return;
        }
    ...
    public Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        if (this.f23924OooO00o == null) {
            ...
            try {
                this.f23925OooO0O0 = this.f23923OooO00o.m15295OooO00o((AbstractC6370iIIIl) OooO00o((PublicKey) key));
                return null;
            } catch (Exception e) {
                throw new InvalidKeyException("calculation failed: " + e.getMessage()) {
                    /* class org.bouncycastle.jcajce.provider.asymmetric.ecgost.KeyAgreementSpi.C48371 */
