...
public class JCERSAPrivateKey implements RSAPrivateKey, AbstractC6786llil {
    public static BigInteger OooO00o = BigInteger.valueOf(0);
    public static final long serialVersionUID = 5110188922551353628L;

    /* renamed from: OooO00o  reason: collision with other field name */
    public transient LLi1i f23981OooO00o = new LLi1i();
    ...
    public JCERSAPrivateKey(liLI1l1i lili1l1i) {
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        ...
        this.f23981OooO00o.OooO00o(objectOutputStream);
    ...
    public AbstractC6854lLi1LL getBagAttribute(LlLI1 llLI1) {
        return this.f23981OooO00o.getBagAttribute(llLI1);
    }

    @Override // com.p118pd.sdk.AbstractC6786llil
    public Enumeration getBagAttributeKeys() {
        return this.f23981OooO00o.getBagAttributeKeys();
    }
    ...
    public void setBagAttribute(LlLI1 llLI1, AbstractC6854lLi1LL r3) {
        this.f23981OooO00o.setBagAttribute(llLI1, r3);
    }
}
