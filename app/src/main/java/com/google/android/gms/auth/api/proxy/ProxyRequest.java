...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    public ProxyRequest(@SafeParcelable.Param(mo10868id = 1000) int i, @SafeParcelable.Param(mo10868id = 1) String str, @SafeParcelable.Param(mo10868id = 2) int i2, @SafeParcelable.Param(mo10868id = 3) long j, @SafeParcelable.Param(mo10868id = 4) byte[] bArr, @SafeParcelable.Param(mo10868id = 5) Bundle bundle) {
        this.versionCode = i;
        this.url = str;
        this.httpMethod = i2;
