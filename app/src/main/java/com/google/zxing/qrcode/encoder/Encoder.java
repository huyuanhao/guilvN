...
public final class Encoder {
    ...
    public static /* synthetic */ class C10831 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.google.zxing.qrcode.encoder.Encoder.C10831.$SwitchMap$com$google$zxing$qrcode$decoder$Mode = r0
            ...
            L_0x0012:
                int[] r0 = com.google.zxing.qrcode.encoder.Encoder.C10831.$SwitchMap$com$google$zxing$qrcode$decoder$Mode     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.google.zxing.qrcode.encoder.Encoder.C10831.$SwitchMap$com$google$zxing$qrcode$decoder$Mode     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.google.zxing.qrcode.encoder.Encoder.C10831.$SwitchMap$com$google$zxing$qrcode$decoder$Mode     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.encoder.Encoder.C10831.<clinit>():void");
        }
    }
    ...
    public static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = C10831.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
