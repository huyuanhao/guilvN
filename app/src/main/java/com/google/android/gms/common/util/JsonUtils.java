...
public final class JsonUtils {
    public static final Pattern zzhc = Pattern.compile("\\\\.");
    public static final Pattern zzhd = Pattern.compile("[\\\\\"/\b\f\n\r\t]");
    ...
    public static String unescapeString(String str) {
        ...
        while (matcher.find()) {
            ...
            if (charAt == '\"') {
                ...
                matcher.appendReplacement(stringBuffer, C8932ooOOO0o.OooO0OO);
            } else if (charAt == '\\') {
                matcher.appendReplacement(stringBuffer, "\\\\");
            } else if (charAt == 'b') {
                matcher.appendReplacement(stringBuffer, "\b");
