...
public class Constants {
    ...
    public static final String SP_KEY_CHANNEL_MODE_ENABLE = "channel_mode_enable";
    ...
    public static final String SP_KEY_KEEP_ALIVE_ENABLE = "keep_alive_enable";
    ...
    public static final String SP_KEY_PULL_UP_ENABLE = "pull_up_enable";
