...
@Monitor(module = "accs", monitorPoint = C3416b.f8468at)
/* renamed from: com.taobao.accs.ut.monitor.SessionMonitor */
public class SessionMonitor extends BaseMonitor {

    /* renamed from: a */
    public long f7165a;
    @Measure(constantValue = AbstractC8352oOoOOoO0.OooO0O0, max = 15000.0d, min = AbstractC8352oOoOOoO0.OooO0O0)
    ...
    @Measure(constantValue = AbstractC8352oOoOOoO0.OooO0O0, max = 86400.0d, min = AbstractC8352oOoOOoO0.OooO0O0)
    ...
    public void onStartConnect() {
        this.f7165a = System.currentTimeMillis();
    }
