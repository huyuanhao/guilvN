...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void setDefaultNotificationChannelId(@NonNull Context context, @NonNull String str) {
        if (PlatformVersion.isAtLeastO()) {
            Preconditions.checkNotNull(((NotificationManager) context.getSystemService(UMessage.DISPLAY_TYPE_NOTIFICATION)).getNotificationChannel(str));
        }
        synchronized (mLock) {
            this.zaap = str;
        }
    ...
    private final void zaa(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            NotificationCompat.OooO0OO OooO00o = new NotificationCompat.OooO0OO(context).OooO0Oo(true).OooO00o(true).OooO0OO((CharSequence) errorNotificationTitle).OooO00o(new NotificationCompat.OooO0O0().OooO00o(errorNotificationMessage));
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                OooO00o.OooO0oO(context.getApplicationInfo().icon).OooO0o(2);
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    OooO00o.OooO00o(C0950R.C0952drawable.common_full_open_on_phone, resources.getString(C0950R.string.common_open_on_phone), pendingIntent);
                } else {
                    OooO00o.OooO00o(pendingIntent);
                }
            } else {
                OooO00o.OooO0oO(17301642).OooO0o0((CharSequence) resources.getString(C0950R.string.common_google_play_services_notification_ticker)).OooO0O0(System.currentTimeMillis()).OooO00o(pendingIntent).OooO0O0((CharSequence) errorNotificationMessage);
            }
            if (PlatformVersion.isAtLeastO()) {
            ...
            Notification OooO00o2 = OooO00o.m14500OooO00o();
            if (i == 1 || i == 2 || i == 3) {
            ...
            notificationManager.notify(i2, OooO00o2);
        }
    }

    public final void zaa(Context context) {
        new zaa(context).sendEmptyMessageDelayed(1, C1IlLiL1.f22762OooO0O0);
    }
}
