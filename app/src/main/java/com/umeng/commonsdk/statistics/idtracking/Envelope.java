...
import com.umeng.commonsdk.proguard.C3618p;
import com.umeng.commonsdk.statistics.common.C3665b;
...
public class Envelope {
    ...
    public byte[] identity = null;
    public String mAddress = null;
    public byte[] mChecksum = null;
    public byte[] mEntity = null;
    ...
    public Envelope(byte[] bArr, String str, byte[] bArr2) throws Exception {
        ...
        this.mEntity = C3665b.m9857a(bArr);
    ...
    public static Envelope genEncryptEnvelope(Context context, String str, byte[] bArr) {
        try {
            ...
            int i = sharedPreferences.getInt(C3683k.f9658a, 1);
            ...
            envelope.seal();
            sharedPreferences.edit().putInt(C3683k.f9658a, i + 1).putString("signature", envelope.getSignature()).commit();
    ...
    public byte[] toBinary() {
        C3618p pVar = new C3618p();
        pVar.mo39005a(this.mVersion);
        pVar.mo39010b(this.mAddress);
        pVar.mo39014c(DataHelper.toHexString(this.mSignature));
        pVar.mo39004a(this.mSerialNo);
        pVar.mo39009b(this.mTimestamp);
        pVar.mo39013c(this.mLength);
        pVar.mo39007a(this.mEntity);
        pVar.mo39017d(this.encrypt ? 1 : 0);
        pVar.mo39018d(DataHelper.toHexString(this.mGuid));
        pVar.mo39023e(DataHelper.toHexString(this.mChecksum));
        try {
            return new C3555ac().mo38869a(pVar);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
