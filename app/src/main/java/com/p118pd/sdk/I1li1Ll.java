...
/* renamed from: com.pd.sdk.I1li1丨Ll  reason: invalid class name */
public class I1li1Ll extends L1ill implements C1l11i {
    ...
    public I1li1Ll(I1li1Ll r2) {
        super(r2);
        this.OooO00o = new int[64];
        OooO00o(r2);
    }

    public I1li1Ll(byte[] bArr) {
        super(bArr);
        this.OooO00o = new int[64];
    ...
    private void OooO00o(I1li1Ll r5) {
    ...
    public int OooO00o(byte[] bArr, int i) {
        ...
        AbstractC6464l1l.OooO00o(this.OooOO0, bArr, i + 28);
        reset();
        return 32;
    }
    ...
    public AbstractC6186iLi1 OooO00o() {
        return new I1li1Ll(this);
    }

    @Override // com.p118pd.sdk.C1l11i, com.p118pd.sdk.L1ill, com.p118pd.sdk.lIL1i11, com.p118pd.sdk.AbstractC6436l11LI, com.p118pd.sdk.AbstractC6186iLi1
    /* renamed from: OooO00o  reason: collision with other method in class */
    public String m15310OooO00o() {
        return LL1i.OooO0Oo;
    }
    ...
    @Override // com.p118pd.sdk.L1ill, com.p118pd.sdk.AbstractC6436l11LI
    /* renamed from: OooO00o  reason: collision with other method in class */
    public void m15311OooO00o(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
    ...
    public void reset() {
        super.reset();
        this.OooO0OO = 1779033703;
        this.OooO0Oo = -1150833019;
        this.OooO0o0 = 1013904242;
        this.OooO0o = -1521486534;
        this.OooO0oO = 1359893119;
        this.OooO0oo = -1694144372;
        this.OooO = 528734635;
        this.OooOO0 = 1541459225;
        this.OooOO0O = 0;
        int i = 0;
        while (true) {
            int[] iArr = this.OooO00o;
