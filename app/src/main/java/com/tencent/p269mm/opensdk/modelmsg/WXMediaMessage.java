...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (pathOldToNew != null && pathOldToNew.length() > 0) {
                try {
                    ...
                    Log.m8651e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        public static String pathNewToOld(String str) {
            ...
            Log.m8651e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }

        public static String pathOldToNew(String str) {
            Log.m8652i(WXMediaMessage.TAG, "pathOldToNew, oldPath = " + str);
            if (str == null || str.length() == 0) {
                Log.m8651e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            int lastIndexOf = str.lastIndexOf(46);
            if (lastIndexOf == -1) {
                Log.m8651e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = " + str);
                return str;
            }
    ...
    public final boolean checkArgs() {
        ...
        } else if (C3392d.m8660a(getType()) && ((bArr2 = this.thumbData) == null || bArr2.length > 131072)) {
            str = "checkArgs fail, thumbData should not be null or exceed 128kb";
        } else if (C3392d.m8660a(getType()) || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.m8651e(TAG, "setThumbImage exception:" + e.getMessage());
        }
    }
}
