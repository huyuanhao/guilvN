...
public final class ConnectionPool {
    ...
    public ConnectionPool(int i, long j, TimeUnit timeUnit) {
        this.cleanupRunnable = new Runnable() {
            /* class okhttp3.ConnectionPool.RunnableC47511 */
            ...
            public void run() {
                ...
                L_0x0030:
                    goto L_0x002f
                */
                throw new UnsupportedOperationException("Method not decompiled: okhttp3.ConnectionPool.RunnableC47511.run():void");
            }
        };
