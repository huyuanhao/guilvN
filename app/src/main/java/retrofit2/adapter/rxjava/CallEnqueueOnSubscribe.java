...
public final class CallEnqueueOnSubscribe<T> implements C9349III.OooO00o<Response<T>> {
    ...
    public void call(AbstractC9508LiLi<? super Response<T>> r3) {
        ...
        final CallArbiter callArbiter = new CallArbiter(clone, r3);
        r3.add(callArbiter);
        r3.setProducer(callArbiter);
        clone.enqueue(new Callback<T>() {
            /* class retrofit2.adapter.rxjava.CallEnqueueOnSubscribe.C48801 */
