...
public class DeleteTokenReq implements IMessageEntity {
    ...
    public String toString() {
        return DeleteTokenReq.class.getName() + " {" + HmsPushConst.NEW_LINE + "pkgName: " + this.pkgName + HmsPushConst.NEW_LINE + "token: " + C1196c.m1295a(this.token) + HmsPushConst.NEW_LINE + C7522o0Ooo0o.OooO0Oo;
    }
}
