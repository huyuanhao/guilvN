...
public final class MediaControllerCompat {
    ...
    public static class MediaControllerExtraData extends ComponentActivity.OooO00o {
    ...
    public static class MediaControllerImplApi23 extends MediaControllerImplApi21 {
        ...
        @Override // android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImpl, android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImplApi21
    ...
    public static class MediaControllerImplApi24 extends MediaControllerImplApi23 {
        ...
        @Override // android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImplApi23, android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImpl, android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImplApi21
        public TransportControls getTransportControls() {
            Object transportControls = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
            if (transportControls != null) {
    ...
    public static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        @Override // android.support.p000v4.media.session.MediaControllerCompat.TransportControls, android.support.p000v4.media.session.MediaControllerCompat.TransportControlsApi21
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        if (str != null) {
            ...
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + str + C9058ooOoOoOO.OooOO0);
            }
        }
    }
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(C6990o000O0oo.OooO00o(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
