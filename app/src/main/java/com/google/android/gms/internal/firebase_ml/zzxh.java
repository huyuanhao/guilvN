...
public final class zzxh extends zzxg {
        ...
        while (i2 < i3) {
            ...
            if (b < 0) {
                if (b < -32) {
                    ...
                    int i6 = i4 + 1;
                    byte b3 = bArr[i4];
                    if (b3 <= -65 && (((b << C8026oOO00oOo.OooO00o) + (b3 + 112)) >> 30) == 0) {
                        int i7 = i6 + 1;
                        if (bArr[i6] <= -65) {
                            i4 = i7 + 1;
                            if (bArr[i7] > -65) {
        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (zzxf.zzi(b2)) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzxf.zzb(b2, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw zzuo.zzrr();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzxf.zzb(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzuo.zzrr();
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                int i10 = i8 + 1;
                bArr[i8] = (byte) ((charAt2 >>> '\f') | CameraManager.OooO0O0);
                int i11 = i10 + 1;
