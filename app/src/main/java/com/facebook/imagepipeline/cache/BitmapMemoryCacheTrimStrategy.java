...
public class BitmapMemoryCacheTrimStrategy implements CountingMemoryCache.CacheTrimStrategy {
    ...
    public static /* synthetic */ class C05031 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.imagepipeline.cache.BitmapMemoryCacheTrimStrategy.C05031.$SwitchMap$com$facebook$common$memory$MemoryTrimType = r0
            ...
            L_0x0012:
                int[] r0 = com.facebook.imagepipeline.cache.BitmapMemoryCacheTrimStrategy.C05031.$SwitchMap$com$facebook$common$memory$MemoryTrimType     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.facebook.imagepipeline.cache.BitmapMemoryCacheTrimStrategy.C05031.$SwitchMap$com$facebook$common$memory$MemoryTrimType     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.facebook.imagepipeline.cache.BitmapMemoryCacheTrimStrategy.C05031.$SwitchMap$com$facebook$common$memory$MemoryTrimType     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.cache.BitmapMemoryCacheTrimStrategy.C05031.<clinit>():void");
        }
    }
    ...
    public double getTrimRatio(MemoryTrimType memoryTrimType) {
        int i = C05031.$SwitchMap$com$facebook$common$memory$MemoryTrimType[memoryTrimType.ordinal()];
        if (i != 1) {
            if (i == 2 || i == 3 || i == 4) {
                return 1.0d;
            }
