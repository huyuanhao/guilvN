...
/* renamed from: com.pd.sdk.l1iLi */
public class l1iLi extends SignatureSpi implements AbstractC5711LiLli, AbstractC5855LLl {
    public IililIi OooO00o = new I1llLIL();

    /* renamed from: OooO00o  reason: collision with other field name */
    public AbstractC6436l11LI f18288OooO00o = new ILilILi();
    public int o00oO0O = 128;
    public int o0ooOO0 = 64;
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        if (privateKey instanceof AbstractC6484lII) {
            ...
            if (r5.OooO00o().OooO0OO().bitLength() >= 505) {
                this.f18288OooO00o.reset();
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (r3.OooO00o().OooO0OO().bitLength() >= 505) {
            this.f18288OooO00o.reset();
    ...
    public byte[] engineSign() throws SignatureException {
        byte[] bArr = new byte[this.f18288OooO00o.OooO0O0()];
        this.f18288OooO00o.OooO00o(bArr, 0);
        try {
    ...
    public void engineUpdate(byte b) throws SignatureException {
        this.f18288OooO00o.update(b);
    }

    @Override // java.security.SignatureSpi
    public void engineUpdate(byte[] bArr, int i, int i2) throws SignatureException {
        this.f18288OooO00o.update(bArr, i, i2);
    }

    @Override // java.security.SignatureSpi
    public boolean engineVerify(byte[] bArr) throws SignatureException {
        byte[] bArr2 = new byte[this.f18288OooO00o.OooO0O0()];
        this.f18288OooO00o.OooO00o(bArr2, 0);
        try {
