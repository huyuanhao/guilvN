...
public class VivoBadgeReceiver extends BroadcastReceiver {
    ...
    public static final String TAG = VivoBadgeReceiver.class.getSimpleName();

    public void onReceive(Context context, Intent intent) {
        try {
            ALog.m7597d(TAG, "onReceive badge broadcast", new Object[0]);
            ...
            if (intExtra2 <= 0 || intExtra != 0) {
                ALog.m7597d(TAG, "onReceive badge reset ", new Object[0]);
                intent2.putExtra("notificationNum", 0);
            } else {
                ALog.m7597d(TAG, "onReceive badge tipNum ", Integer.valueOf(intExtra2));
            ...
            ALog.m7598e(TAG, "onReceive badge error ", e, new Object[0]);
            e.printStackTrace();
        }
    }
}
