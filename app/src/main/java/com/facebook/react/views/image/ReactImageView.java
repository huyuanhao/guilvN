...
public class ReactImageView extends GenericDraweeView {
    ...
    public ImageResizeMethod mResizeMethod = ImageResizeMethod.AUTO;
    ...
    private boolean shouldResize(ImageSource imageSource) {
        ...
        if (imageResizeMethod != ImageResizeMethod.AUTO) {
            return imageResizeMethod == ImageResizeMethod.RESIZE;
        }
    ...
    public void setShouldNotifyLoadEvents(boolean z) {
        if (!z) {
            ...
            this.mControllerListener = new BaseControllerListener<ImageInfo>() {
                /* class com.facebook.react.views.image.ReactImageView.C08651 */
