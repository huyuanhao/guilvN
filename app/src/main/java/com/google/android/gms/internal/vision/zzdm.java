...
public final class zzdm extends zzjn<zzdm> {
    public static volatile zzdm[] zzoo;
    public String name = null;
    public String zzop = null;
    public String[] zzoq = zzjw.zzady;
    public zzcz.zzd.zzb zzor;
