...
public enum TextTransform {
    ...
    public static /* synthetic */ class C08811 {
        public static final /* synthetic */ int[] $SwitchMap$com$facebook$react$views$text$TextTransform;
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.react.views.text.TextTransform.C08811.$SwitchMap$com$facebook$react$views$text$TextTransform = r0
            ...
            L_0x0012:
                int[] r0 = com.facebook.react.views.text.TextTransform.C08811.$SwitchMap$com$facebook$react$views$text$TextTransform     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.facebook.react.views.text.TextTransform.C08811.$SwitchMap$com$facebook$react$views$text$TextTransform     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.text.TextTransform.C08811.<clinit>():void");
        }
    }
    ...
    public static String apply(String str, TextTransform textTransform) {
        ...
        int i = C08811.$SwitchMap$com$facebook$react$views$text$TextTransform[textTransform.ordinal()];
        if (i == 1) {
