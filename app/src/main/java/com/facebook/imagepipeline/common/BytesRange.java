...
public class BytesRange {
    ...
    public boolean contains(@Nullable BytesRange bytesRange) {
        return bytesRange != null && this.from <= bytesRange.from && this.f964to >= bytesRange.f964to;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.from == bytesRange.from && this.f964to == bytesRange.f964to) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return HashCodeUtil.hashCode(this.from, this.f964to);
    }

    public String toHttpRangeHeaderValue() {
        return String.format(null, "bytes=%s-%s", valueOrEmpty(this.from), valueOrEmpty(this.f964to));
    }

    public String toString() {
        return String.format(null, "%s-%s", valueOrEmpty(this.from), valueOrEmpty(this.f964to));
    }
}
