        ...
        while (!arrayDeque.isEmpty()) {
            ...
            if (animatedNode5 instanceof PropsAnimatedNode) {
                try {
                    ...
                    FLog.m874e(ReactConstants.TAG, "Native animation workaround, frame lost as result of race condition", e);
                }
            }
    ...
    public void onEventDispatch(final Event event) {
        if (UiThreadUtil.isOnUiThread()) {
            ...
            UiThreadUtil.runOnUiThread(new Runnable() {
                /* class com.facebook.react.animated.NativeAnimatedNodesManager.RunnableC06291 */
