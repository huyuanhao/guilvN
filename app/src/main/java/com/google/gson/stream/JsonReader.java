...
public class JsonReader implements Closeable {
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
            /* class com.google.gson.stream.JsonReader.C10621 */
    ...
    public double nextDouble() throws IOException {
        ...
        if (i == 16) {
            ...
            this.peekedString = nextQuotedValue(i == 8 ? '\'' : C8318oOo0oooo.OooO00o);
        } else if (i == 10) {
    ...
    public String nextName() throws IOException {
        ...
        if (i == 14) {
            ...
            str = nextQuotedValue(C8318oOo0oooo.OooO00o);
        } else {
        ...
        do {
            ...
            if (i2 == 3) {
                ...
                if (i2 == 4) {
                    ...
                    skipQuotedValue(C8318oOo0oooo.OooO00o);
                    this.peeked = 0;
                } else {
                    if (i2 == 16) {
                        this.pos += this.peekedNumberLength;
