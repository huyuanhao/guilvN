...
public class C6165iLIIlIL implements li1l11I1 {
    ...
    private void OooO00o(boolean z, byte[] bArr) {
        ...
        if (length != 16) {
            ...
            this.f17716OooO0O0 = false;
        } else {
            this.f17716OooO0O0 = true;
            iArr[0] = OooO00o(bArr, 0);
            iArr[1] = OooO00o(bArr, 4);
            iArr[2] = OooO00o(bArr, 8);
            iArr[3] = OooO00o(bArr, 12);
        ...
        if (this.f17716OooO0O0) {
            int[] iArr5 = this.f17717OooO0O0;
            if (z) {
                iArr5[0] = iArr[0];
                iArr5[1] = iArr[1];
                iArr5[2] = iArr[2];
                iArr5[3] = iArr[3];
                OooO0OO(15, iArr, 0, this.f17715OooO00o, 4);
                OooO0OO(30, iArr, 0, this.f17715OooO00o, 12);
                OooO0OO(15, iArr, 0, iArr4, 0);
                int[] iArr6 = this.f17715OooO00o;
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                OooO0OO(17, iArr, 0, this.OooO0OO, 4);
                OooO0OO(17, iArr, 0, this.f17715OooO00o, 24);
                OooO0OO(17, iArr, 0, this.f17715OooO00o, 32);
                int[] iArr7 = this.f17715OooO00o;
                iArr7[0] = iArr2[0];
                iArr7[1] = iArr2[1];
                iArr7[2] = iArr2[2];
                iArr7[3] = iArr2[3];
                ...
                int[] iArr8 = this.f17715OooO00o;
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                OooO0OO(15, iArr2, 0, iArr8, 20);
                OooO0Oo(34, iArr2, 0, this.f17715OooO00o, 28);
                OooO0OO(17, iArr2, 0, this.f17717OooO0O0, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            iArr5[6] = iArr[2];
            iArr5[7] = iArr[3];
            OooO00o(15, iArr, 0, this.f17715OooO00o, 28);
            OooO00o(30, iArr, 0, this.f17715OooO00o, 20);
            OooO00o(15, iArr, 0, iArr4, 0);
            int[] iArr9 = this.f17715OooO00o;
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            OooO00o(17, iArr, 0, this.OooO0OO, 0);
            OooO00o(17, iArr, 0, this.f17715OooO00o, 8);
            OooO00o(17, iArr, 0, this.f17715OooO00o, 0);
            int[] iArr10 = this.f17715OooO00o;
            iArr10[34] = iArr2[0];
            iArr10[35] = iArr2[1];
            iArr10[32] = iArr2[2];
            iArr10[33] = iArr2[3];
            ...
            int[] iArr11 = this.f17715OooO00o;
            iArr11[18] = iArr4[2];
            iArr11[19] = iArr4[3];
            OooO00o(15, iArr2, 0, iArr11, 12);
            OooO0O0(34, iArr2, 0, this.f17715OooO00o, 4);
            OooO0OO(17, iArr2, 0, this.f17717OooO0O0, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        int[] iArr12 = this.f17717OooO0O0;
        if (z) {
            iArr12[0] = iArr[0];
            iArr12[1] = iArr[1];
            iArr12[2] = iArr[2];
            iArr12[3] = iArr[3];
            OooO0Oo(45, iArr, 0, this.f17715OooO00o, 16);
            OooO0OO(15, iArr, 0, this.OooO0OO, 4);
            OooO0OO(17, iArr, 0, this.f17715OooO00o, 32);
            OooO0Oo(34, iArr, 0, this.f17715OooO00o, 44);
            OooO0OO(15, iArr, 4, this.f17715OooO00o, 4);
            OooO0OO(15, iArr, 4, this.OooO0OO, 0);
            OooO0OO(30, iArr, 4, this.f17715OooO00o, 24);
            OooO0Oo(34, iArr, 4, this.f17715OooO00o, 36);
            OooO0OO(15, iArr2, 0, this.f17715OooO00o, 8);
            OooO0OO(30, iArr2, 0, this.f17715OooO00o, 20);
            int[] iArr13 = this.OooO0OO;
            iArr13[8] = iArr2[1];
            iArr13[9] = iArr2[2];
            iArr13[10] = iArr2[3];
            iArr13[11] = iArr2[0];
            OooO0Oo(49, iArr2, 0, this.f17715OooO00o, 40);
            int[] iArr14 = this.f17715OooO00o;
            iArr14[0] = iArr3[0];
            iArr14[1] = iArr3[1];
            iArr14[2] = iArr3[2];
            iArr14[3] = iArr3[3];
            OooO0OO(30, iArr3, 0, iArr14, 12);
            OooO0OO(30, iArr3, 0, this.f17715OooO00o, 28);
            OooO0Oo(51, iArr3, 0, this.f17717OooO0O0, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        iArr12[6] = iArr[2];
        iArr12[7] = iArr[3];
        OooO0O0(45, iArr, 0, this.f17715OooO00o, 28);
        OooO00o(15, iArr, 0, this.OooO0OO, 4);
        OooO00o(17, iArr, 0, this.f17715OooO00o, 12);
        OooO0O0(34, iArr, 0, this.f17715OooO00o, 0);
        OooO00o(15, iArr, 4, this.f17715OooO00o, 40);
        OooO00o(15, iArr, 4, this.OooO0OO, 8);
        OooO00o(30, iArr, 4, this.f17715OooO00o, 20);
        OooO0O0(34, iArr, 4, this.f17715OooO00o, 8);
        OooO00o(15, iArr2, 0, this.f17715OooO00o, 36);
        OooO00o(30, iArr2, 0, this.f17715OooO00o, 24);
        int[] iArr15 = this.OooO0OO;
        iArr15[2] = iArr2[1];
        iArr15[3] = iArr2[2];
        iArr15[0] = iArr2[3];
        iArr15[1] = iArr2[0];
        OooO0O0(49, iArr2, 0, this.f17715OooO00o, 4);
        int[] iArr16 = this.f17715OooO00o;
        iArr16[46] = iArr3[0];
        iArr16[47] = iArr3[1];
        iArr16[44] = iArr3[2];
        iArr16[45] = iArr3[3];
        OooO00o(30, iArr3, 0, iArr16, 32);
        OooO00o(30, iArr3, 0, this.f17715OooO00o, 16);
        OooO0Oo(51, iArr3, 0, this.f17717OooO0O0, 0);
    }
    ...
    private void OooO00o(int[] iArr, int[] iArr2, int i) {
        ...
        iArr[0] = iArr[0] ^ i15;
        iArr[1] = (i15 ^ OooO0O0(i13, 8)) ^ iArr[1];
    }
    ...
    private int OooO0O0(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            ...
            iArr[i3] = iArr[i3] ^ this.f17717OooO0O0[i3];
        }
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 0);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 4);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 8);
        OooO0O0(this.OooO0Oo, this.OooO0OO, 0);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 12);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 16);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 20);
        OooO0O0(this.OooO0Oo, this.OooO0OO, 4);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 24);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 28);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 32);
        int[] iArr2 = this.OooO0Oo;
        int i4 = iArr2[2];
        int[] iArr3 = this.f17717OooO0O0;
        iArr2[2] = iArr3[4] ^ i4;
    ...
    private int OooO0OO(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 36);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 40);
        OooO00o(this.OooO0Oo, this.f17715OooO00o, 44);
        int[] iArr2 = this.OooO0Oo;
        int i4 = iArr2[2];
        int[] iArr3 = this.f17717OooO0O0;
        iArr2[2] = i4 ^ iArr3[4];
    ...
    public int OooO00o(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        if (!this.f17714OooO00o) {
            throw new IllegalStateException("Camellia engine not initialised");
        } else if (i + 16 > bArr.length) {
            throw new DataLengthException("input buffer too short");
        } else if (i2 + 16 <= bArr2.length) {
            return this.f17716OooO0O0 ? OooO0O0(bArr, i, bArr2, i2) : OooO0OO(bArr, i, bArr2, i2);
        } else {
