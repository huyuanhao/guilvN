...
/* renamed from: com.pd.sdk.L1II1ii丨  reason: invalid class name */
public class L1II1ii extends IIiLIli.OooO0O0 {
    public static final int OooOO0 = 6;
    public C6445l1IliI OooO00o = new C6445l1IliI(this, null, null);

    /* renamed from: com.pd.sdk.L1II1ii丨$OooO00o */
    public class OooO00o implements AbstractC6100iILll {
        public final /* synthetic */ int OooO00o;

        /* renamed from: OooO00o  reason: collision with other field name */
        public final /* synthetic */ long[] f16157OooO00o;

        public OooO00o(int i, long[] jArr) {
            this.OooO00o = i;
            this.f16157OooO00o = jArr;
        }
        ...
        public AbstractC9738llL1L OooO00o(int i) {
            ...
            for (int i3 = 0; i3 < this.OooO00o; i3++) {
                ...
                for (int i4 = 0; i4 < 3; i4++) {
                    long j2 = OooO00o2[i4];
                    long[] jArr = this.f16157OooO00o;
                    OooO00o2[i4] = j2 ^ (jArr[i2 + i4] & j);
                    OooO00o3[i4] = OooO00o3[i4] ^ (jArr[(i2 + 3) + i4] & j);
                }
                i2 += 6;
            }
            return L1II1ii.this.OooO00o((AbstractC97441iIIL) new C6219ii11(OooO00o2), (AbstractC97441iIIL) new C6219ii11(OooO00o3), false);
        }
    }
    ...
    public L1II1ii() {
        ...
        ((IIiLIli) this).f15500OooO0O0 = OooO00o(new BigInteger(1, C6472l1l1l.OooO00o("020A601907B8C953CA1481EB10512F78744A3205FD")));
        ((IIiLIli) this).f15499OooO00o = new BigInteger(1, C6472l1l1l.OooO00o("040000000000000000000292FE77E70C12A4234C33"));
