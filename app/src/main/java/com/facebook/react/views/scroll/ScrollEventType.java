...
public enum ScrollEventType {
    ...
    public static /* synthetic */ class C08751 {
        public static final /* synthetic */ int[] $SwitchMap$com$facebook$react$views$scroll$ScrollEventType;
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.react.views.scroll.ScrollEventType.C08751.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType = r0
            ...
            L_0x0012:
                int[] r0 = com.facebook.react.views.scroll.ScrollEventType.C08751.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.facebook.react.views.scroll.ScrollEventType.C08751.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.facebook.react.views.scroll.ScrollEventType.C08751.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = com.facebook.react.views.scroll.ScrollEventType.C08751.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.scroll.ScrollEventType.C08751.<clinit>():void");
        }
    }

    public static String getJSEventName(ScrollEventType scrollEventType) {
        int i = C08751.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType[scrollEventType.ordinal()];
        if (i == 1) {
