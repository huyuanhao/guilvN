...
public class FontMetricsUtil {
    public static final float AMPLIFICATION_FACTOR = 100.0f;
    public static final String CAP_HEIGHT_MEASUREMENT_TEXT = "T";
    public static final String X_HEIGHT_MEASUREMENT_TEXT = "x";
