...
public class LayoutShadowNode extends ReactShadowNodeImpl {
    public final MutableYogaValue mTempYogaValue = new MutableYogaValue((C08381) null);
    ...
    public static /* synthetic */ class C08381 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.react.uimanager.LayoutShadowNode.C08381.$SwitchMap$com$facebook$yoga$YogaUnit = r0
                com.facebook.yoga.YogaUnit r1 = com.facebook.yoga.YogaUnit.POINT     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = com.facebook.react.uimanager.LayoutShadowNode.C08381.$SwitchMap$com$facebook$yoga$YogaUnit     // Catch:{ NoSuchFieldError -> 0x001d }
                com.facebook.yoga.YogaUnit r1 = com.facebook.yoga.YogaUnit.UNDEFINED     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = com.facebook.react.uimanager.LayoutShadowNode.C08381.$SwitchMap$com$facebook$yoga$YogaUnit     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.facebook.yoga.YogaUnit r1 = com.facebook.yoga.YogaUnit.AUTO     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = com.facebook.react.uimanager.LayoutShadowNode.C08381.$SwitchMap$com$facebook$yoga$YogaUnit     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.LayoutShadowNode.C08381.<clinit>():void");
        }
    }
    ...
    public static class MutableYogaValue {
        ...
        public /* synthetic */ MutableYogaValue(C08381 r1) {
            this();
        }
    ...
    public void setFlexBasis(Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            int i = C08381.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i == 1 || i == 2) {
    ...
    public void setMargins(int i, Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            this.mTempYogaValue.setFromDynamic(dynamic);
            int i2 = C08381.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i2 == 1 || i2 == 2) {
    ...
    @ReactPropGroup(names = {ViewProps.START, ViewProps.END, "left", "right", "top", "bottom"})
