...
public class ImageLabeler extends Detector<ImageLabel> {
    public static final LabelOptions zzdq = new LabelOptions(-1);
    public final zzi zzdp;

    @ShowFirstParty
    @KeepForSdk
    public static class Builder {
        public ImageLabelerOptions zzdr = new ImageLabelerOptions(ImageLabelerOptions.zza(Locale.getDefault().getLanguage()), -1, 0.5f, 1);
        public Context zze;
