...
/* renamed from: com.pd.sdk.O000O0000Oo0 */
public class O000O0000Oo0 implements AbstractC8893ooOO00O0 {
    public static String TAG = o0OOOOO.OooO00o(new byte[]{10, 86, 66, 88, 70, 3, 59, 81, 68, 94, 93, 57, C3587az.f9268l, 86, 64, 80}, "d7610f");
    public static String file_sec = o0OOOOO.OooO00o(new byte[]{3, 87, 85, 0, 2, 3, 81, 82, 86, 1, 6}, "bfc211");
    public static O000O0000Oo0 instance;

    public static O000O0000Oo0 getInstance() {
        if (instance == null) {
            synchronized (O000O0000Oo0.class) {
                if (instance == null) {
                    instance = new O000O0000Oo0();
                }
            }
        }
        return instance;
