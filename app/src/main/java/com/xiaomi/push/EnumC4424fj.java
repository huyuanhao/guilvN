...
public enum EnumC4424fj {
    ...
    GSLB_TCP_CONNREFUSED(HandlerRequestCode.REQUEST_QQ_SHARE),
    GSLB_TCP_NOROUTETOHOST(HandlerRequestCode.REQUEST_QZONE_SHARE),
    GSLB_TCP_TIMEOUT(10105),
    GSLB_TCP_INVALARG(10106),
    GSLB_TCP_UKNOWNHOST(10107),
    GSLB_TCP_ERR_OTHER(10199),
    GSLB_ERR(10999),
    CONN_SUCCESS(C7486o0OoO0oO.OooO0o),
    ...
    /* renamed from: a */
    public static EnumC4424fj m12551a(int i) {
        if (i == 30501) {
            return BIND_TIMEOUT;
        }
        if (i == 30502) {
                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            case HandlerRequestCode.REQUEST_QQ_SHARE:
                                return GSLB_TCP_CONNREFUSED;
                            case HandlerRequestCode.REQUEST_QZONE_SHARE:
