...
public final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    public static final char f1018FS = 28;

    /* renamed from: GS */
    public static final char f1019GS = 29;
    public static final char LATCHA = 65527;
    public static final char LATCHB = 65528;
    public static final char LOCK = 65529;

    /* renamed from: NS */
    public static final char f1020NS = 65531;
    public static final char PAD = 65532;

    /* renamed from: RS */
    public static final char f1021RS = 30;
    ...
    public static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f1019GS + format + f1019GS + format2 + f1019GS);
            } else {
                sb.insert(0, str + f1019GS + format + f1019GS + format2 + f1019GS);
            }
        } else if (i == 4) {
    ...
    public static int getCountry(byte[] bArr) {
        return getInt(bArr, new byte[]{53, 54, 43, 44, 45, 46, 47, 48, C8027oOO00oo.OooO0OO, 38});
    }
    ...
    public static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{PublicSuffixDatabase.EXCEPTION_MARKER, 34, 35, 36, 25, 26, C8027oOO00oo.OooO0Oo, C8026oOO00oOo.OooO00o, 29, 30, 19, 20, 21, 22, 23, 24, 13, C3587az.f9268l, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    public static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, ExifInterface.OooO00o, C3571am.f9204j, 32});
    }

    public static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, ExifInterface.OooO00o, C3571am.f9204j, 32})), SETS[0].charAt(getInt(bArr, new byte[]{PublicSuffixDatabase.EXCEPTION_MARKER, 34, 35, 36, 25, 26})), SETS[0].charAt(getInt(bArr, new byte[]{C8027oOO00oo.OooO0Oo, C8026oOO00oOo.OooO00o, 29, 30, 19, 20})), SETS[0].charAt(getInt(bArr, new byte[]{21, 22, 23, 24, 13, C3587az.f9268l})), SETS[0].charAt(getInt(bArr, new byte[]{15, 16, 17, 18, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
