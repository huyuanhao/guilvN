...
public class AccsConfig {
    ...
    public static boolean mInitConfig;
    ...
    public static void build() {
        try {
            ...
            if (AccsClientConfig.loadedStaticConfig) {
                if (configByTag != null) {
                    ALog.m7603w(TAG, "default config already exists", new Object[0]);
                    return;
                }
            }
            getBuilder().build();
        } catch (AccsException e) {
            ALog.m7598e(TAG, "build config error", e, new Object[0]);
        }
    }
    ...
    public static void setAccsCenterHosts(String str, String str2, String str3) {
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2) || TextUtils.isEmpty(str3)) {
            ALog.m7599e(TAG, "setAccsCenterHost null", new Object[0]);
            return;
        }
        ALog.m7600i(TAG, "setAccsCenterHost", "env", Integer.valueOf(ACCSManager.mEnv), "releaseHost", str, "prepareHost", str2, "dailyHost", str3);
    ...
    public static void setChannelHosts(String str, String str2, String str3) {
        ALog.m7600i(TAG, "env", Integer.valueOf(ACCSManager.mEnv), "setChannelHosts", "releaseHost", str, "prepareHost", str2, "dailyHost", str3);
        int i = ACCSManager.mEnv;
        if (i == 1) {
    ...
    public static void setSecurityGuardOff(SECURITY_TYPE security_type) {
        C3103a.f6871a = security_type.ordinal();
    }

    public static void setTnetPubkey(int i, int i2) {
        ALog.m7600i(TAG, "setTnetPubkey", "pubKey", Integer.valueOf(i), "channelPubKey", Integer.valueOf(i2));
