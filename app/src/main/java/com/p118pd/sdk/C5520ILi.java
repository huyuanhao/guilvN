...
public class C5520ILi extends L1ill {
    ...
    private void OooO00o(C5520ILi r5) {
    ...
    public AbstractC6186iLi1 OooO00o() {
        return new C5520ILi(this);
    }

    @Override // com.p118pd.sdk.L1ill, com.p118pd.sdk.lIL1i11, com.p118pd.sdk.AbstractC6436l11LI, com.p118pd.sdk.AbstractC6186iLi1
    /* renamed from: OooO00o  reason: collision with other method in class */
    public String m15793OooO00o() {
        return "RIPEMD256";
    }
    ...
    @Override // com.p118pd.sdk.L1ill, com.p118pd.sdk.AbstractC6436l11LI
    /* renamed from: OooO00o  reason: collision with other method in class */
    public void m15794OooO00o(byte[] bArr, int i) {
        int[] iArr = this.OooO00o;
        int i2 = this.OooOO0O;
        int i3 = i2 + 1;
        this.OooOO0O = i3;
    ...
    public void OooO0OO() {
        ...
        int OooO0oo2 = OooO0oo(i5, i6, i7, i8, this.OooO00o[5], 8);
        int OooO0oo3 = OooO0oo(i8, OooO0oo2, i6, i7, this.OooO00o[14], 9);
        int OooO0oo4 = OooO0oo(i7, OooO0oo3, OooO0oo2, i6, this.OooO00o[7], 9);
        int OooO0oo5 = OooO0oo(i6, OooO0oo4, OooO0oo3, OooO0oo2, this.OooO00o[0], 11);
        ...
        int OooO0O0 = OooO0O0(OooO0oo14, OooO00o17, OooO00o16, OooO00o15, this.OooO00o[7], 7);
        ...
        int OooO0oO2 = OooO0oO(OooO00o14, OooO0oo17, OooO0oo16, OooO0oo15, this.OooO00o[6], 9);
        ...
        int OooO0OO2 = OooO0OO(OooO0O013, OooO0oO17, OooO0O015, OooO0O014, this.OooO00o[3], 11);
        int OooO0OO3 = OooO0OO(OooO0O014, OooO0OO2, OooO0oO17, OooO0O015, this.OooO00o[10], 13);
        int OooO0OO4 = OooO0OO(OooO0O015, OooO0OO3, OooO0OO2, OooO0oO17, this.OooO00o[14], 6);
        int OooO0OO5 = OooO0OO(OooO0oO17, OooO0OO4, OooO0OO3, OooO0OO2, this.OooO00o[4], 7);
        ...
        int OooO0o2 = OooO0o(OooO0oO14, OooO0O016, OooO0oO16, OooO0oO15, this.OooO00o[15], 9);
        int OooO0o3 = OooO0o(OooO0oO15, OooO0o2, OooO0O016, OooO0oO16, this.OooO00o[5], 7);
        int OooO0o4 = OooO0o(OooO0oO16, OooO0o3, OooO0o2, OooO0O016, this.OooO00o[1], 15);
        int OooO0o5 = OooO0o(OooO0O016, OooO0o4, OooO0o3, OooO0o2, this.OooO00o[3], 11);
        ...
        int OooO0Oo2 = OooO0Oo(OooO0OO14, OooO0OO17, OooO0o16, OooO0OO15, this.OooO00o[1], 11);
        int OooO0Oo3 = OooO0Oo(OooO0OO15, OooO0Oo2, OooO0OO17, OooO0o16, this.OooO00o[9], 12);
        int OooO0Oo4 = OooO0Oo(OooO0o16, OooO0Oo3, OooO0Oo2, OooO0OO17, this.OooO00o[11], 14);
        ...
        int OooO0o02 = OooO0o0(OooO0o14, OooO0o17, OooO0OO16, OooO0o15, this.OooO00o[8], 15);
        int OooO0o03 = OooO0o0(OooO0o15, OooO0o02, OooO0o17, OooO0OO16, this.OooO00o[6], 5);
        int OooO0o04 = OooO0o0(OooO0OO16, OooO0o03, OooO0o02, OooO0o17, this.OooO00o[4], 8);
        ...
        this.OooO0OO += OooO0Oo14;
        this.OooO0Oo += OooO0Oo17;
        this.OooO0o0 += OooO0Oo16;
        this.OooO0o += OooO0o015;
        this.OooO0oO += OooO0o014;
        this.OooO0oo += OooO0o017;
        this.OooO += OooO0o016;
    ...
    public void reset() {
        ...
        this.OooO0oo = -19088744;
        this.OooO = -1985229329;
        this.OooOO0 = 19088743;
        this.OooOO0O = 0;
        int i = 0;
        while (true) {
            int[] iArr = this.OooO00o;
