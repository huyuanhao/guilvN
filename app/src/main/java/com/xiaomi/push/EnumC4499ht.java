...
public enum EnumC4499ht {
    ...
    StatDataProcessFrequency(TinkerReport.KEY_APPLIED_DEXOPT_EXIST),
    StatDataSwitch(TinkerReport.KEY_APPLIED_DEXOPT_FORMAT),
    StatDataUploadWay(124),
    StatDataDeleteFrequency(C7531o0Oooo0o.OooO0O0),
