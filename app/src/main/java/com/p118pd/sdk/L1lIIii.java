...
/* renamed from: com.pd.sdk.丨L1lIIii  reason: invalid class name */
public class L1lIIii extends C6744ll1L {
    public int OooO0O0;

    public L1lIIii(li1l11I1 li1l11i1) {
        if ((li1l11i1 instanceof IlLilI) || (li1l11i1 instanceof C9750I)) {
    ...
    public int OooO00o(byte[] bArr, int i) throws DataLengthException, IllegalStateException, InvalidCipherTextException {
        if (((C6744ll1L) this).OooO00o + i <= bArr.length) {
            ...
            int i2 = ((C6744ll1L) this).OooO00o - OooO00o;
            ...
            if (((C6744ll1L) this).f18717OooO00o) {
                ...
                if (i3 >= OooO00o) {
                    while (true) {
                        ...
                        bArr3[i3] = bArr2[i3 - OooO00o];
                        i3++;
                    }
                    for (int i4 = OooO00o; i4 != ((C6744ll1L) this).OooO00o; i4++) {
                        byte[] bArr4 = ((C6744ll1L) this).f18718OooO00o;
                        bArr4[i4] = (byte) (bArr4[i4] ^ bArr2[i4 - OooO00o]);
                    }
                    ...
                    System.arraycopy(bArr2, 0, bArr, i + OooO00o, i2);
                } else {
                ...
                for (int i5 = OooO00o; i5 != ((C6744ll1L) this).OooO00o; i5++) {
                    int i6 = i5 - OooO00o;
                    bArr5[i6] = (byte) (bArr2[i6] ^ ((C6744ll1L) this).f18718OooO00o[i5]);
                }
                System.arraycopy(((C6744ll1L) this).f18718OooO00o, OooO00o, bArr2, 0, i2);
                ((C6744ll1L) this).f18716OooO00o.OooO00o(bArr2, 0, bArr, i);
                System.arraycopy(bArr5, 0, bArr, i + OooO00o, i2);
            }
            int i7 = ((C6744ll1L) this).OooO00o;
            m17843OooO00o();
            return i7;
        }
