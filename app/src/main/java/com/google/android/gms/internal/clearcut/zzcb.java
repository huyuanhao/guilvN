...
public enum zzcb {
    ...
    SFIXED64(14, zzcd.SCALAR, zzcq.zzkz),
    SINT32(15, zzcd.SCALAR, zzcq.INT),
    SINT64(16, zzcd.SCALAR, zzcq.zzkz),
    GROUP(17, zzcd.SCALAR, zzcq.MESSAGE),
    DOUBLE_LIST(18, zzcd.VECTOR, zzcq.DOUBLE),
    FLOAT_LIST(19, zzcd.VECTOR, zzcq.FLOAT),
    INT64_LIST(20, zzcd.VECTOR, zzcq.zzkz),
    UINT64_LIST(21, zzcd.VECTOR, zzcq.zzkz),
    INT32_LIST(22, zzcd.VECTOR, zzcq.INT),
    FIXED64_LIST(23, zzcd.VECTOR, zzcq.zzkz),
    ...
    SFIXED64_LIST(32, zzcd.VECTOR, zzcq.zzkz),
    SINT32_LIST(33, zzcd.VECTOR, zzcq.INT),
    SINT64_LIST(34, zzcd.VECTOR, zzcq.zzkz),
    ...
    UINT64_LIST_PACKED(38, zzcd.PACKED_VECTOR, zzcq.zzkz),
    INT32_LIST_PACKED(39, zzcd.PACKED_VECTOR, zzcq.INT),
    FIXED64_LIST_PACKED(40, zzcd.PACKED_VECTOR, zzcq.zzkz),
    ...
    SFIXED64_LIST_PACKED(46, zzcd.PACKED_VECTOR, zzcq.zzkz),
    SINT32_LIST_PACKED(47, zzcd.PACKED_VECTOR, zzcq.INT),
    SINT64_LIST_PACKED(48, zzcd.PACKED_VECTOR, zzcq.zzkz),
    ...
    static {
        ...
        for (zzcb zzcb : values) {
            zzjb[zzcb.f996id] = zzcb;
        }
    }

    /* access modifiers changed from: public */
    zzcb(int i, zzcd zzcd, zzcq zzcq) {
        int i2;
        this.f996id = i;
        this.zziy = zzcd;
        this.zzix = zzcq;
