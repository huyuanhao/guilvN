...
public final class zzjl {
    ...
    public zzjl(byte[] bArr, int i, int i2) {
    ...
    public static void zzd(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
        int i2;
        char charAt;
            ...
            if (byteBuffer.hasArray()) {
                    ...
                    if (i3 == length) {
                        ...
                        while (i3 < length) {
                            ...
                            if (charAt2 < 128 && i < i4) {
                                ...
                                int i7 = i + 1;
                                array[i] = (byte) ((charAt2 >>> '\f') | CameraManager.OooO0O0);
                                int i8 = i7 + 1;
                ...
                while (i3 < length2) {
                    ...
                    if (charAt4 < 128) {
                        ...
                        byteBuffer.put((byte) ((charAt4 >>> '\f') | CameraManager.OooO0O0));
    ...
    public zzjl(ByteBuffer byteBuffer) {
