...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    public class LocalImagesProgressiveDecoder extends ProgressiveDecoder {
        ...
        public QualityInfo getQualityInfo() {
            return ImmutableQualityInfo.m942of(0, false, false);
        }
    ...
    public abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        public ProgressiveDecoder(Consumer<CloseableReference<CloseableImage>> consumer, final ProducerContext producerContext, final boolean z) {
            ...
            this.mJobScheduler = new JobScheduler(DecodeProducer.this.mExecutor, new JobScheduler.JobRunnable(DecodeProducer.this) {
                /* class com.facebook.imagepipeline.producers.DecodeProducer.ProgressiveDecoder.C05391 */
            ...
            this.mProducerContext.addCallbacks(new BaseProducerContextCallbacks(DecodeProducer.this) {
                /* class com.facebook.imagepipeline.producers.DecodeProducer.ProgressiveDecoder.C05402 */
        ...
        private Map<String, String> getExtraMap(@Nullable CloseableImage closeableImage, long j, QualityInfo qualityInfo, boolean z, String str, String str2, String str3, String str4) {
            ...
            if (closeableImage instanceof CloseableStaticBitmap) {
                ...
                hashMap.put("bitmapSize", underlyingBitmap.getWidth() + FontMetricsUtil.X_HEIGHT_MEASUREMENT_TEXT + underlyingBitmap.getHeight());
        ...
        private void handleResult(CloseableImage closeableImage, int i) {
            CloseableReference of = CloseableReference.m937of(closeableImage);
            try {
    ...
    public void produceResults(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext) {
        ...
        if (!UriUtil.isNetworkUri(producerContext.getImageRequest().getSourceUri())) {
            consumer2 = new LocalImagesProgressiveDecoder(consumer, producerContext, this.mDecodeCancellationEnabled);
        } else {
            consumer2 = new NetworkImagesProgressiveDecoder(consumer, producerContext, new ProgressiveJpegParser(this.mByteArrayPool), this.mProgressiveJpegConfig, this.mDecodeCancellationEnabled);
        }
