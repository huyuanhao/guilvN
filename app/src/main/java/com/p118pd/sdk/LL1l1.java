...
/* renamed from: com.pd.sdk.LL1l丨丨1  reason: invalid class name */
public class LL1l1 extends IIiLIli.OooO0O0 {
    public static final int OooOO0 = 6;
    public LLIiILii OooO00o = new LLIiILii(this, null, null);

    /* renamed from: com.pd.sdk.LL1l丨丨1$OooO00o */
    public class OooO00o implements AbstractC6100iILll {
        public final /* synthetic */ int OooO00o;

        /* renamed from: OooO00o  reason: collision with other field name */
        public final /* synthetic */ long[] f16407OooO00o;

        public OooO00o(int i, long[] jArr) {
            this.OooO00o = i;
            this.f16407OooO00o = jArr;
        }
        ...
        public AbstractC9738llL1L OooO00o(int i) {
            ...
            for (int i3 = 0; i3 < this.OooO00o; i3++) {
                ...
                for (int i4 = 0; i4 < 3; i4++) {
                    long j2 = OooO00o2[i4];
                    long[] jArr = this.f16407OooO00o;
                    OooO00o2[i4] = j2 ^ (jArr[i2 + i4] & j);
                    OooO00o3[i4] = OooO00o3[i4] ^ (jArr[(i2 + 3) + i4] & j);
                }
                i2 += 6;
            }
            return LL1l1.this.OooO00o((AbstractC97441iIIL) new C6219ii11(OooO00o2), (AbstractC97441iIIL) new C6219ii11(OooO00o3), false);
        }
    }

    public LL1l1() {
        super(163, 3, 6, 7);
        AbstractC97441iIIL OooO00o2 = OooO00o(BigInteger.valueOf(1));
        ((IIiLIli) this).f15498OooO00o = OooO00o2;
        ((IIiLIli) this).f15500OooO0O0 = OooO00o2;
        ((IIiLIli) this).f15499OooO00o = new BigInteger(1, C6472l1l1l.OooO00o("04000000000000000000020108A2E0CC0D99F8A5EF"));
