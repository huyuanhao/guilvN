...
/* renamed from: com.pd.sdk.l1Ll  reason: case insensitive filesystem */
public final class C6451l1Ll<T, U> implements C9349III.OooO0O0<C9349III<T>, T> {
    public static final Object OooO00o = new Object();

    /* renamed from: OooO00o  reason: collision with other field name */
    public final C9349III<U> f18274OooO00o;
    ...
    public C6451l1Ll(C9349III<U> r1) {
        this.f18274OooO00o = r1;
    }
    ...
    public AbstractC9508LiLi<? super T> call(AbstractC9508LiLi<? super C9349III<T>> r3) {
        ...
        r3.add(oooO00o);
        oooO0O0.OooO0o();
        this.f18274OooO00o.OooO0O0(oooO00o);
        return oooO0O0;
    }
    ...
    public static final class OooO0O0<T> extends AbstractC9508LiLi<T> {
        ...
        /* renamed from: OooO00o  reason: collision with other field name */
        public C9349III<T> f18275OooO00o;

        /* renamed from: OooO00o  reason: collision with other field name */
        public final AbstractC9508LiLi<? super C9349III<T>> f18276OooO00o;

        /* renamed from: OooO00o  reason: collision with other field name */
        public final Object f18277OooO00o = new Object();

        /* renamed from: OooO00o  reason: collision with other field name */
        public List<Object> f18278OooO00o;
        public boolean OooO0O0;

        public OooO0O0(AbstractC9508LiLi<? super C9349III<T>> r2) {
            this.f18276OooO00o = new IL11lL(r2);
        }

        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.pd.sdk.l1Ll$OooO0O0<T> */
        /* JADX WARN: Multi-variable type inference failed */
        public void OooO00o(List<Object> list) {
            if (list != null) {
                for (Object obj : list) {
                    if (obj == C6451l1Ll.OooO00o) {
                        OooO0o0();
        ...
        public void OooO0O0(Throwable th) {
            ...
            this.OooO00o = null;
            this.f18275OooO00o = null;
            if (r0 != null) {
                r0.onError(th);
            }
            this.f18276OooO00o.onError(th);
            unsubscribe();
        }
        ...
        public void OooO0OO() {
            ...
            this.f18276OooO00o.onCompleted();
            unsubscribe();
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:0x0043, code lost:
            if (r6.f18276OooO00o.isUnsubscribed() == false) goto L_0x004f;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:52:0x005f, code lost:
            monitor-enter(r6.f18277OooO00o);
         */
        ...
        public void OooO0o() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p118pd.sdk.C6451l1Ll.OooO0O0.OooO0o():void");
        }
        ...
        public void OooO0o0() {
            ...
            OooO0Oo();
            this.f18276OooO00o.onNext(this.f18275OooO00o);
        }

        @Override // com.p118pd.sdk.AbstractC5477Il11
        public void onCompleted() {
            synchronized (this.f18277OooO00o) {
                if (this.OooO0O0) {
                    if (this.f18278OooO00o == null) {
                        this.f18278OooO00o = new ArrayList();
                    }
                    this.f18278OooO00o.add(NotificationLite.OooO00o());
                    return;
                }
                List<Object> list = this.f18278OooO00o;
                this.f18278OooO00o = null;
                this.OooO0O0 = true;
                try {
                    OooO00o(list);
                    OooO0OO();
        ...
        public void onError(Throwable th) {
            synchronized (this.f18277OooO00o) {
                if (this.OooO0O0) {
                    this.f18278OooO00o = Collections.singletonList(NotificationLite.OooO00o(th));
                    return;
                }
                this.f18278OooO00o = null;
                this.OooO0O0 = true;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:0x0041, code lost:
            if (r6.f18276OooO00o.isUnsubscribed() == false) goto L_0x004d;
         */
        ...
        public void onNext(T r7) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p118pd.sdk.C6451l1Ll.OooO0O0.onNext(java.lang.Object):void");
        }
