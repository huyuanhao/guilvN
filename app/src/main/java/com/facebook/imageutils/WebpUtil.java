...
public class WebpUtil {
    ...
    public static int getInt(InputStream inputStream) throws IOException {
        return ((((byte) inputStream.read()) << 24) & -16777216) | ((((byte) inputStream.read()) << 16) & C7265o0O000oo.OooOo0O) | ((((byte) inputStream.read()) << 8) & 65280) | (((byte) inputStream.read()) & 255);
    }
    ...
    public static Pair<Integer, Integer> getSize(InputStream inputStream) {
        ...
        try {
            ...
            getInt(inputStream);
            inputStream.read(bArr);
            if (!compare(bArr, C8132oOOOOooo.OooO0oo)) {
                if (inputStream != null) {
                    try {
                        inputStream.close();
    ...
    public static int read3Bytes(InputStream inputStream) throws IOException {
        ...
        return ((getByte(inputStream) << 16) & C7265o0O000oo.OooOo0O) | ((getByte(inputStream) << 8) & 65280) | (b & 255);
    }
}
