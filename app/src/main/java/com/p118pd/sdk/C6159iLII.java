...
public class C6159iLII extends X509CRL {
    public C5190I1lIiL OooO00o;

    /* renamed from: OooO00o  reason: collision with other field name */
    public byte[] f17699OooO00o;
    public boolean OooO0O0;
    public boolean OooO0OO = false;
    public int o00oO0O;
    public String o0ooOOo;

    public C6159iLII(C5190I1lIiL r4) throws CRLException {
        this.OooO00o = r4;
        try {
            this.o0ooOOo = C1iIii.OooO00o(r4.m15325OooO00o());
            if (r4.m15325OooO00o().m17587OooO0O0() != null) {
                this.f17699OooO00o = r4.m15325OooO00o().m17587OooO0O0().OooO0O0().OooO00o(AbstractC5533IiL.OooO00o);
            } else {
                this.f17699OooO00o = null;
            }
    ...
    private Set OooO00o() {
        ...
        while (OooO00o3.hasMoreElements()) {
            ...
            hashSet.add(new liiililI(oooO0O0, this.OooO0O0, r2));
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof C6159iLII)) {
            return super.equals(obj);
        }
        C6159iLII ilii = (C6159iLII) obj;
        if (!this.OooO0OO || !ilii.OooO0OO || ilii.o00oO0O == this.o00oO0O) {
            return this.OooO00o.equals(ilii.OooO00o);
        }
        return false;
    }
    ...
    public X509CRLEntry getRevokedCertificate(BigInteger bigInteger) {
        ...
        while (OooO00o3.hasMoreElements()) {
            ...
            if (bigInteger.equals(oooO0O0.m17910OooO00o().m17647OooO0O0())) {
                return new liiililI(oooO0O0, this.OooO0O0, r2);
            }
            if (this.OooO0O0 && oooO0O0.m17911OooO00o() && (OooO00o2 = oooO0O0.m17909OooO00o().OooO00o(C5237III.o00Ooooo)) != null) {
                r2 = l1LILI1.OooO00o(C5845LIillll.OooO00o(OooO00o2.m15435OooO0O0()).OooO00o()[0].m15483OooO0O0());
            }
    ...
    public boolean hasUnsupportedCriticalExtension() {
        ...
        criticalExtensionOIDs.remove(C6396iiLiL.OooO0Oo);
        criticalExtensionOIDs.remove(C6396iiLiL.OooO0o);
