...
/* renamed from: com.pd.sdk.lLIL1 */
public class lLIL1 extends AbstractC5903LlLLL {
    public static final byte[] OooO00o = new byte[0];

    public lLIL1(boolean z, int i, AbstractC6854lLi1LL r3) {
        super(z, i, r3);
    }
    ...
    public void OooO00o(C6103iIi1 iii1) throws IOException {
        int i = 160;
        if (!this.OooO0O0) {
            AbstractC6122iIlLiL OooO0o0 = this.OooO00o.OooO0O0().OooO0o0();
            if (this.OooO0OO) {
                iii1.OooO00o(160, this.o00oO0O);
                iii1.OooO0O0(OooO0o0.OooO0O0());
                iii1.OooO00o((AbstractC6854lLi1LL) OooO0o0);
                return;
            }
            if (!OooO0o0.OooO00o()) {
                i = 128;
    ...
    public boolean OooO00o() {
        ...
        return this.OooO00o.OooO0O0().OooO0o0().OooO00o();
    }
    ...
    public int OooO0O0() throws IOException {
        ...
        int OooO0O02 = this.OooO00o.OooO0O0().OooO0o0().OooO0O0();
        if (this.OooO0OO) {
