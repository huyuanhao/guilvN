...
public final class MinElf {
    ...
    public static int getu16(FileChannel fileChannel, ByteBuffer byteBuffer, long j) throws IOException {
        ...
        return byteBuffer.getShort() & UShort.OooO0OO;
    }
    ...
    public static String[] extract_DT_NEEDED(FileChannel fileChannel) throws IOException {
        ...
        if (getu32(fileChannel, allocate, 0) == 1179403647) {
            ...
            if (j2 == WebSocketProtocol.PAYLOAD_SHORT_MAX) {
                if (z2) {
                    j16 = getu32(fileChannel, allocate, 32);
                } else {
                    j16 = get64(fileChannel, allocate, 40);
                }
                if (z2) {
            ...
            while (true) {
                ...
                if (j15 == 2) {
                    j3 = z2 ? getu32(fileChannel, allocate, j18 + 4) : get64(fileChannel, allocate, j18 + 8);
                } else {
                    j18 += (long) i;
                    j19++;
                }
            ...
            if (j3 != 0) {
                ...
                while (true) {
                    ...
                    if (j4 == 1) {
                        ...
                        if (j4 == 5) {
                            if (z) {
                                j14 = getu32(fileChannel, allocate, j21 + 4);
                            } else {
                                j14 = get64(fileChannel, allocate, j21 + 8);
                            }
                            j22 = j14;
                        }
                    }
                    ...
                    if (j4 != 0) {
                        ...
                        while (true) {
                            ...
                            if (z) {
                                j9 = getu32(fileChannel, allocate, j + j20);
                            } else {
                                j9 = getu32(fileChannel, allocate, j + j20);
                            }
                            if (j9 == 1) {
                        ...
                        if (j6 != 0) {
                            ...
                            while (true) {
                                if (z) {
                                    j7 = getu32(fileChannel, allocate, j5 + j24);
                                } else {
                                    j7 = get64(fileChannel, allocate, j5 + j24);
                                }
                                if (j7 == 1) {
                                    if (z) {
                                        j8 = getu32(fileChannel, allocate, j5 + 4);
                                    } else {
                                        j8 = get64(fileChannel, allocate, j5 + 8);
                                    }
