...
public abstract class BaseLayoutAnimation extends AbstractLayoutAnimation {
    ...
    public static /* synthetic */ class C08591 {
        ...
        public static final /* synthetic */ int[] f985x36728427;
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.react.uimanager.layoutanimation.BaseLayoutAnimation.C08591.f985x36728427 = r0
            ...
            L_0x0012:
                int[] r0 = com.facebook.react.uimanager.layoutanimation.BaseLayoutAnimation.C08591.f985x36728427     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = com.facebook.react.uimanager.layoutanimation.BaseLayoutAnimation.C08591.f985x36728427     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = com.facebook.react.uimanager.layoutanimation.BaseLayoutAnimation.C08591.f985x36728427     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.layoutanimation.BaseLayoutAnimation.C08591.<clinit>():void");
        }
    }
    ...
    public Animation createAnimationImpl(View view, int i, int i2, int i3, int i4) {
        ...
        if (animatedPropertyType != null) {
            int i5 = C08591.f985x36728427[animatedPropertyType.ordinal()];
            float f = 0.0f;
            if (i5 == 1) {
