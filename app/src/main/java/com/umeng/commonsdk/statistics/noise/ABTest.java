...
public class ABTest implements AbstractC3701d {
    ...
    public ABTest(Context context2, String str, int i) {
    ...
    public void onImprintChanged(ImprintHandler.C3671a aVar) {
        onExperimentChanged(aVar.mo39233a("client_test", null), Integer.valueOf(aVar.mo39233a("test_report_interval", "0")).intValue());
    }
