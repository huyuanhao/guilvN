...
public class DataHelper {
    ...
    /* renamed from: iv */
    public static final byte[] f9585iv = {10, 1, 11, 5, 4, 15, 7, 9, 23, 3, 1, 6, 8, 12, 13, 91};
    ...
    public static byte[] decrypt(byte[] bArr, byte[] bArr2) throws Exception {
        ...
        instance.init(2, new SecretKeySpec(bArr2, "AES"), new IvParameterSpec(f9585iv));
        return instance.doFinal(bArr);
    }

    public static byte[] encrypt(byte[] bArr, byte[] bArr2) throws Exception {
        Cipher instance = Cipher.getInstance("AES/CBC/PKCS7Padding");
        instance.init(1, new SecretKeySpec(bArr2, "AES"), new IvParameterSpec(f9585iv));
        return instance.doFinal(bArr);
    }
