...
/* renamed from: com.pd.sdk.I丨LI丨1  reason: invalid class name and case insensitive filesystem */
public class C5518ILI1 extends SignatureSpi implements AbstractC5711LiLli, AbstractC5855LLl {
    public IililIi OooO00o = new C6887llllli();

    /* renamed from: OooO00o  reason: collision with other field name */
    public AbstractC6436l11LI f16019OooO00o = new C6846lLIlii();

    /* renamed from: OooO00o  reason: collision with other field name */
    public SecureRandom f16020OooO00o;
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        ...
        this.f16019OooO00o.reset();
        SecureRandom secureRandom = this.f16020OooO00o;
    ...
    public void engineInitSign(PrivateKey privateKey, SecureRandom secureRandom) throws InvalidKeyException {
        this.f16020OooO00o = secureRandom;
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof ECPublicKey) {
            r3 = IlllII1.OooO00o(publicKey);
        } else if (publicKey instanceof AbstractC5419Il1i) {
            r3 = C6886llll.OooO00o(publicKey);
        } else {
            try {
                PublicKey publicKey2 = BouncyCastleProvider.getPublicKey(C6888ll.OooO00o(publicKey.getEncoded()));
                if (publicKey2 instanceof ECPublicKey) {
                    r3 = IlllII1.OooO00o(publicKey2);
                } else {
    ...
    public byte[] engineSign() throws SignatureException {
        byte[] bArr = new byte[this.f16019OooO00o.OooO0O0()];
        this.f16019OooO00o.OooO00o(bArr, 0);
        try {
    ...
    public void engineUpdate(byte b) throws SignatureException {
        this.f16019OooO00o.update(b);
    }

    @Override // java.security.SignatureSpi
    public void engineUpdate(byte[] bArr, int i, int i2) throws SignatureException {
        this.f16019OooO00o.update(bArr, i, i2);
    }

    @Override // java.security.SignatureSpi
    public boolean engineVerify(byte[] bArr) throws SignatureException {
        byte[] bArr2 = new byte[this.f16019OooO00o.OooO0O0()];
        this.f16019OooO00o.OooO00o(bArr2, 0);
        try {
