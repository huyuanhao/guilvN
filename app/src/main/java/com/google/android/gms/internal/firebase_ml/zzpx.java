...
public final class zzpx {
    public static final zzpx zzaxp = new zzpx();
    ...
    public static byte[] zza(@androidx.annotation.NonNull byte[] r7, int r8, int r9) {
        ...
        L_0x002f:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase_ml.zzpx.zza(byte[], int, int):byte[]");
    }
    ...
    public static byte[] zza(@androidx.annotation.NonNull android.graphics.Bitmap r4) {
        ...
        L_0x001f:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase_ml.zzpx.zza(android.graphics.Bitmap):byte[]");
    }
    ...
    @TargetApi(19)
    public static void zza(Image.Plane plane, int i, int i2, byte[] bArr, int i3, int i4) {
    ...
    public static /* synthetic */ void zza(Throwable th, ByteArrayOutputStream byteArrayOutputStream) {
        if (th != null) {
            try {
