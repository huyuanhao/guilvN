...
public class UInAppMessage {
    ...
    public UInAppMessage(JSONObject jSONObject) throws JSONException {
        ...
        if (i == 5 || i == 6) {
            ...
            this.plainTextActivity = jSONObject3.optString(C5982OoooOoO.OooO0o0, "");
            this.plainTextUrl = jSONObject3.optString("url", "");
        }
        if (jSONObject2.has(SocializeProtocolConstants.IMAGE)) {
            JSONObject jSONObject4 = jSONObject2.getJSONObject(SocializeProtocolConstants.IMAGE);
            ...
            this.action_activity = jSONObject4.optString(C5982OoooOoO.OooO0o0, "");
        ...
        if (jSONObject2.has("bottom_image")) {
            ...
            this.bottom_action_activity = jSONObject5.optString(C5982OoooOoO.OooO0o0, "");
        ...
        if (jSONObject2.has("custom_button")) {
            ...
            this.customButtonActivity = jSONObject6.optString(C5982OoooOoO.OooO0o0, "");
        ...
        this.start_time = jSONObject7.getString(C3416b.f8489p);
