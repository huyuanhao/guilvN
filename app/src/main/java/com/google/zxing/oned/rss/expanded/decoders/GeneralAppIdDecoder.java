    ...
    private DecodedChar decodeIsoIec646(int i) throws FormatException {
        ...
        switch (extractNumericValueFromBitArray(i, 8)) {
            case 232:
                ...
                break;
            case 233:
                c = C8318oOo0oooo.OooO00o;
                break;
            case 234:
                c = '%';
                break;
            case 235:
                c = C8318oOo0oooo.OooO0OO;
                break;
            case 236:
                c = '\'';
                break;
            ...
            case 247:
                ...
                break;
            case 248:
                c = C7490o0OoOO0o.OooO00o;
                break;
            case C7637o0oOo0OO.OooO0o /*{ENCODED_INT: 249}*/:
                c = C8318oOo0oooo.OooO0o0;
                break;
            case 250:
                c = '?';
                break;
            case TinkerReport.KEY_LOADED_UNCAUGHT_EXCEPTION /*{ENCODED_INT: 251}*/:
                c = '_';
                break;
            case TinkerReport.KEY_LOADED_EXCEPTION_DEX /*{ENCODED_INT: 252}*/:
                c = ' ';
                break;
            default:
