...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C3387a.m8656b(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C3387a.m8655a(bundle, "_wxapi_payoptions_callback_flags");
        }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C3387a.m8656b(bundle, "_wxapi_payreq_appid");
        this.partnerId = C3387a.m8656b(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C3387a.m8656b(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C3387a.m8656b(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C3387a.m8656b(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C3387a.m8656b(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C3387a.m8656b(bundle, "_wxapi_payreq_sign");
        this.extData = C3387a.m8656b(bundle, "_wxapi_payreq_extdata");
        this.signType = C3387a.m8656b(bundle, "_wxapi_payreq_sign_type");
