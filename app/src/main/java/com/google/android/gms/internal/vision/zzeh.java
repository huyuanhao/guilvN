...
public final class zzeh {
    public static int zza(byte[] bArr, int i, zzei zzei) {
        int i2 = i + 1;
        byte b = bArr[i];
        if (b < 0) {
    ...
    public static int zzb(byte[] bArr, int i, zzei zzei) {
        int i2 = i + 1;
        long j = (long) bArr[i];
        if (j >= 0) {
            zzei.zzrp = j;
    ...
    public static int zze(byte[] bArr, int i, zzei zzei) throws zzgf {
    ...
    public static int zzc(byte[] bArr, int i, zzei zzei) throws zzgf {
        int zza = zza(bArr, i, zzei);
        int i2 = zzei.zzro;
        if (i2 < 0) {
            throw zzgf.zzfi();
    ...
    public static int zzd(byte[] bArr, int i, zzei zzei) throws zzgf {
        int zza = zza(bArr, i, zzei);
        int i2 = zzei.zzro;
        if (i2 < 0) {
            throw zzgf.zzfi();
    ...
    public static int zza(int i, byte[] bArr, int i2, zzei zzei) {
        int i3 = i & 127;
        int i4 = i2 + 1;
        byte b = bArr[i2];
        if (b >= 0) {
        ...
        byte b2 = bArr[i4];
        if (b2 >= 0) {
            zzei.zzro = i5 | (b2 << C3587az.f9268l);
            return i6;
        }
        ...
        byte b4 = bArr[i8];
        if (b4 >= 0) {
            zzei.zzro = i9 | (b4 << C8026oOO00oOo.OooO00o);
            return i10;
        }
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzge<?> zzge, zzei zzei) {
        zzfz zzfz = (zzfz) zzge;
    ...
    public static int zza(byte[] bArr, int i, zzge<?> zzge, zzei zzei) throws IOException {
        zzfz zzfz = (zzfz) zzge;
        int zza = zza(bArr, i, zzei);
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzip zzip, zzei zzei) throws zzgf {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
                ...
                while (true) {
                    ...
                    int zza3 = zza(i7, bArr, zza2, i3, zzhf, zzei);
                    i7 = i8;
                    i2 = zza3;
                }
                if (i2 > i3 || i7 != i6) {
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzei zzei) throws zzgf {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
