...
public final class DistinguishedNameParser {
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f13425dn);
            } else {
                i2 = c - '7';
            }
    ...
    private char getEscaped() {
        ...
        throw new IllegalStateException("Unexpected end of DN: " + this.f13425dn);
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f13425dn.toCharArray();
