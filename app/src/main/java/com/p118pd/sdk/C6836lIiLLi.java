...
/* renamed from: com.pd.sdk.l丨Ii丨LLi  reason: invalid class name and case insensitive filesystem */
public class C6836lIiLLi implements IililIi {
    public C5611LI1 OooO00o;

    /* renamed from: OooO00o  reason: collision with other field name */
    public SecureRandom f18893OooO00o;
    ...
    public void OooO00o(boolean z, AbstractC6370iIIIl r2) {
        ...
        if (!z) {
            ...
            this.f18893OooO00o = r23.m17752OooO00o();
            this.OooO00o = (C6512lIilLl) r23.OooO00o();
            return;
        } else {
            this.f18893OooO00o = IIllii.OooO00o();
            r22 = (C6512lIilLl) r2;
        }
        this.OooO00o = r22;
    }
    ...
    public BigInteger[] OooO00o(byte[] bArr) {
        ...
        while (true) {
            BigInteger bigInteger2 = new BigInteger(OooO0OO.bitLength(), this.f18893OooO00o);
